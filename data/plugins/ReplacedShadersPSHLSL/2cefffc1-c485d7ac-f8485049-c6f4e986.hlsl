  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.w = max(0, r3.w);
  r3.w = r4.w * r3.w;
  r8.xyz = cb0[33].xyz + -v6.xyz;
  r8.xyz = cb0[33].www * r8.xyz;
  r4.w = dot(r8.xyz, r8.xyz);
  r4.w = sqrt(r4.w);
  r5.w = dot(r8.xyz, r4.xyz);
  r5.w = saturate(r5.w / r4.w);
  r4.w = 1 + -r4.w;
  r4.w = max(0, r4.w);
  r4.w = r5.w * r4.w;
  r8.xyz = cb0[34].xyz * r4.www;
  r8.xyz = cb0[32].xyz * r3.www + r8.xyz;
  r9.xyz = cb0[35].xyz + -v6.xyz;
  r9.xyz = cb0[35].www * r9.xyz;
  ...
  r5.w = max(0, r5.w);
  r4.w = r5.w * r4.w;
  r5.w = dot(cb0[36].xyz, -r9.xyz);
  r3.w = r5.w / r3.w;
  r3.w = -cb0[37].w + r3.w;
  r3.w = saturate(cb0[36].w * r3.w);
  r9.xyz = cb0[37].xyz * r4.www;
  r8.xyz = r9.xyz * r3.www + r8.xyz;
  r9.xyz = cb0[38].xyz + -v6.xyz;
  r9.xyz = cb0[38].www * r9.xyz;
  r3.w = dot(r9.xyz, r9.xyz);
  r3.w = sqrt(r3.w);
  r4.w = dot(r9.xyz, r4.xyz);
  r4.w = saturate(r4.w / r3.w);
  ...
  r3.w = r5.w / r3.w;
  r3.w = -cb0[40].w + r3.w;
  r3.w = saturate(cb0[39].w * r3.w);
  r9.xyz = cb0[40].xyz * r4.www;
  r8.xyz = r9.xyz * r3.www + r8.xyz;
  ...
  r1.x = exp2(r1.x);
  r1.x = r1.x * r1.y;
  r6.x = r3.w * 0.939999998 + 0.0500000007;
  r6.yw = float2(0.5,0.5);
  r1.yzw = t3.Sample(s3_s, r6.xy).xyz;
  r6.z = r1.x * 0.939999998 + 0.0500000007;
