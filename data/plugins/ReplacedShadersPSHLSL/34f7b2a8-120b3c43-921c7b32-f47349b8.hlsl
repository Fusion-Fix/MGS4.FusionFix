  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = exp2(r0.w);
  r0.w = r0.w * r1.x;
  r6.x = r0.w * 0.939999998 + 0.0500000007;
  r6.yw = float2(0.5,0.5);
  r7.xyz = t5.Sample(s5_s, r6.xy).xyz;
  r0.w = r2.w * 0.75 + 0.25;
  r8.xyz = cb0[9].xyz * r0.www;
  r9.xyz = cb0[4].xyz * r8.xyz;
  r9.xyz = r9.xyz * r7.xyz;
  r10.xyz = cb0[10].xyz * cb0[4].xyz;
  r7.xyz = r10.xyz * r7.xyz;
  r6.z = r3.w * 0.939999998 + 0.0500000007;
  r6.xyz = t3.Sample(s3_s, r6.zw).xyz;
  r1.x = r1.y * 0.939999998 + 0.0500000007;
  r1.y = 0.5;
  ...
  r4.xyz = r9.xyz * float3(0.5,0.5,0.5) + -r2.xyz;
  r2.xyz = r1.www * r4.xyz + r2.xyz;
  r2.xyz = max(float3(0,0,0), r2.xyz);
  r0.xyz = r0.xyz * r5.xyz + r2.xyz;
  r2.xyz = cb0[10].xyz * r3.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r2.xyz = r7.xyz * float3(0.5,0.5,0.5) + -r1.xyz;
