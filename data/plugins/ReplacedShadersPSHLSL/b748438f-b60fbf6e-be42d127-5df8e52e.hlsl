// ---- Created with 3Dmigoto v1.2.45 on Sun Aug 30 19:17:53 2026
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = (int)r1.x + -1;
  r1.x = (int)r1.x;
  r1.y = dot(v2.xyz, cb0[0].xyz);
  r1.zw = float2(0.699999988,0.699999988) * cb0[3].xy;
  r2.xy = v3.xy / v3.ww;
  ...
  r3.z = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r4.y = r1.w * rotY + r2.y;
      r4.w = r2.z;
      r3.w = t1.SampleCmpLevelZero(s1_s, r4.xy, r4.w).x;
      r3.y = r3.w + r3.y;
    }
  }
  r1.x = 1 / cb0[4].x;
  ...
  r2.x = max(cb0[1].z, v1.x);
  r2.x = min(cb0[1].w, r2.x);
  r2.x = cb0[2].w * r2.x;
  r0.xyz = -r0.xyz * r1.xxx + cb0[2].xyz;
