  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r5.xyz = r4.xyz * r1.www + cb0[18].xyz;
  ...
  r4.yzw = cb0[11].xyz * r4.www + r5.xyz;
  r0.w = r0.w * 0.75 + 0.25;
  r5.xyz = cb0[9].xyz * r0.www;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r6.xyz = cb0[34].xyz * r1.www;
  r6.xyz = cb0[32].xyz * r0.www + r6.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[36].xyz, -r7.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[37].w + r0.w;
  r0.w = saturate(cb0[36].w * r0.w);
  r7.xyz = cb0[37].xyz * r1.www;
