  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = r1.x / r1.w;
  r1.x = -cb0[36].w + r1.x;
  r1.x = saturate(cb0[35].w * r1.x);
  r1.yzw = cb0[36].xyz * r2.xxx;
  r2.xyz = cb0[37].xyz + -v7.xyz;
  ...
  r2.x = r2.x / r2.w;
  r2.x = -cb0[39].w + r2.x;
  r2.x = saturate(cb0[38].w * r2.x);
  r2.yzw = cb0[39].xyz * r3.xxx;
  r3.x = r2.z * r2.x;
  r3.x = r1.z * r1.x + r3.x;
  r3.x = saturate(3 * r3.x);
  r3.x = cmp(r3.x < 0.498039216);
  if (r3.x != 0) discard;
  r3.xyz = -cb0[22].xyz + v7.xyz;
  r4.x = dot(r3.xyz, r3.xyz);
  r4.x = rsqrt(r4.x);
  r4.yzw = r4.xxx * r3.xyz;
  r5.xyz = t0.Sample(s0_s, w2.xy).xyz;
  r6.xyz = t4.Sample(s4_s, v3.xy).xyz;
  r7.xyz = t2.Sample(s2_s, w2.xy).xyz;
  ...
  r7.w = saturate(dot(-r0.xyz, cb0[19].xyz));
  r8.xyz = cb0[8].xyz * r3.www;
  r9.xyz = cb0[9].xyz * r6.www;
  r8.xyz = r8.xyz * r5.www + r9.xyz;
  r8.xyz = cb0[10].xyz * r7.www + r8.xyz;
  r9.xyz = cb0[30].xyz + -v7.xyz;
  r9.xyz = cb0[30].www * r9.xyz;
  r5.w = dot(r9.xyz, r9.xyz);
  r5.w = sqrt(r5.w);
  r6.w = dot(r9.xyz, r0.xyz);
  r6.w = saturate(r6.w / r5.w);
  r5.w = 1 + -r5.w;
  r5.w = max(0, r5.w);
  r5.w = r6.w * r5.w;
  r9.xyz = cb0[32].xyz + -v7.xyz;
  r9.xyz = cb0[32].www * r9.xyz;
  r6.w = dot(r9.xyz, r9.xyz);
  r6.w = sqrt(r6.w);
  r7.w = dot(r9.xyz, r0.xyz);
  r7.w = saturate(r7.w / r6.w);
  r6.w = 1 + -r6.w;
  r6.w = max(0, r6.w);
  r6.w = r7.w * r6.w;
  r9.xyz = cb0[33].xyz * r6.www;
  r9.xyz = cb0[31].xyz * r5.www + r9.xyz;
  r1.xyz = r1.yzw * r1.xxx + r9.xyz;
  r1.xyz = r2.yzw * r2.xxx + r1.xyz;
  r1.xyz = r8.xyz + r1.xyz;
  r1.w = dot(-r0.xyz, cb0[16].xyz);
  r2.xyz = cb0[11].xyz * r1.www + cb0[12].xyz;
  r2.xyz = cb0[1].xyz * r2.xyz;
  r1.xyz = r1.xyz * cb0[0].xyz + r2.xyz;
  r2.xyz = float3(-1,-1,-1) + cb0[3].xyz;
  r2.xyz = r0.www * r2.xyz + float3(1,1,1);
  r1.w = cb0[3].w + -cb0[1].w;
  r1.w = r0.w * r1.w + cb0[1].w;
  r1.w = v1.y * -r1.w + r1.w;
  r2.w = 1 + v1.y;
  r2.xyz = r2.xyz * r2.www;
  r2.w = dot(r0.xyz, -cb0[17].xyz);
  r8.xyz = r3.xyz * r4.xxx + cb0[17].xyz;
  r5.w = dot(r8.xyz, r8.xyz);
  r5.w = rsqrt(r5.w);
  r8.xyz = r8.xyz * r5.www;
  r5.w = saturate(dot(-r0.xyz, r8.xyz));
  ...
  r3.xyz = r3.xyz * r4.xxx + cb0[18].xyz;
  r4.x = dot(r3.xyz, r3.xyz);
  r4.x = rsqrt(r4.x);
  ...
  r1.w = exp2(r1.w);
  r1.w = r1.w * r3.y;
  r3.xyz = r6.xyz * cb0[2].xyz + -r5.xyz;
