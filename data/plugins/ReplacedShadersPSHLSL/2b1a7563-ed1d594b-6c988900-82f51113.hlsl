  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = (int)r1.x + -1;
  r1.x = (int)r1.x;
  r1.yz = float2(0.699999988,0.699999988) * cb0[15].xy;
  r2.xy = v11.xy / v11.ww;
  ...
  r5.xyzw = t3.Sample(s3_s, v4.zw).xyzw;
  r1.w = r5.w * 255 + -128;
  r1.w = 0.0840641856 * r1.w;
  r1.w = exp2(r1.w);
  r4.xyz = r5.xyz * r1.www + r4.xyz;
  r5.x = saturate(dot(r2.xyz, float3(0.707099974,-0.408199996,0.577400029)));
  r5.y = saturate(dot(r2.xyz, float3(-0.707099974,-0.408199996,0.577400029)));
  r5.z = saturate(dot(r2.yz, float2(0.816500008,0.577400029)));
  r2.xyz = r5.xyz * r5.xyz;
  r5.xyz = v6.xyz * r2.yyy;
  r2.xyw = v5.xyz * r2.xxx + r5.xyz;
  ...
  r2.y = max(0, r2.y);
  r2.x = r2.x * r2.y;
  r2.yzw = cb0[19].xyz + -v10.xyz;
  r2.yzw = cb0[19].www * r2.yzw;
  ...
  r2.z = max(0, r2.z);
  r2.y = r2.y * r2.z;
  r2.yzw = cb0[20].xyz * r2.yyy;
  r2.xyz = cb0[18].xyz * r2.xxx + r2.yzw;
  r4.xyz = cb0[21].xyz + -v10.xyz;
  r4.xyz = cb0[21].www * r4.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.x = dot(cb0[22].xyz, -r4.xyz);
  r2.w = r4.x / r2.w;
  r2.w = -cb0[23].w + r2.w;
  r2.w = saturate(cb0[22].w * r2.w);
  r4.xyz = cb0[23].xyz * r3.www;
  r2.xyz = r4.xyz * r2.www + r2.xyz;
  r4.xyz = cb0[24].xyz + -v10.xyz;
  r4.xyz = cb0[24].www * r4.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = sqrt(r2.w);
  r3.w = dot(r4.xyz, r3.xyz);
  r3.w = saturate(r3.w / r2.w);
  ...
  r2.w = r4.x / r2.w;
  r2.w = -cb0[26].w + r2.w;
  r2.w = saturate(cb0[25].w * r2.w);
  r4.xyz = cb0[26].xyz * r3.www;
  r2.xyz = r4.xyz * r2.www + r2.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = -cb0[13].xyz + v10.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  ...
  r1.x = max(cb0[11].z, w2.x);
  r1.x = min(cb0[11].w, r1.x);
  r1.x = cb0[12].w * r1.x;
  r1.yzw = cb0[12].xyz + -r0.xyz;
