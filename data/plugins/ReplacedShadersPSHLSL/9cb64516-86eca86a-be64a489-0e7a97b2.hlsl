  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r1.x : 0;
  r1.x = saturate(dot(-cb0[9].xyz, r4.xyz));
  ...
  r1.y = max(0, r1.y);
  r1.y = r2.w * r1.y;
  r3.xyz = cb0[19].xyz * r1.yyy;
  r3.xyz = cb0[17].xyz * r1.xxx + r3.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.y = r2.w * r1.y;
  r2.w = dot(cb0[21].xyz, -r5.xyz);
  r1.x = r2.w / r1.x;
  r1.x = -cb0[22].w + r1.x;
  r1.x = saturate(cb0[21].w * r1.x);
  r5.xyz = cb0[22].xyz * r1.yyy;
  ...
  r1.x = r2.w / r1.x;
  r1.x = -cb0[25].w + r1.x;
  r1.x = saturate(cb0[24].w * r1.x);
  r5.xyz = cb0[25].xyz * r1.yyy;
  r3.xyz = r5.xyz * r1.xxx + r3.xyz;
