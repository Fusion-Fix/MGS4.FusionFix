  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = max(0, r0.w);
  r0.w = r1.w * r0.w;
  r2.xyz = cb0[18].xyz + -v10.xyz;
  r2.xyz = cb0[18].www * r2.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.x * r1.w;
  r2.xyz = cb0[19].xyz * r1.www;
  r2.xyz = cb0[17].xyz * r0.www + r2.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[21].xyz, -r4.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[22].w + r0.w;
  r0.w = saturate(cb0[21].w * r0.w);
  r4.xyz = cb0[22].xyz * r1.www;
  ...
  r0.w = r2.w / r0.w;
  r0.w = -cb0[25].w + r0.w;
  r0.w = saturate(cb0[24].w * r0.w);
  r3.xyz = cb0[25].xyz * r1.www;
