  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r3.w : 0;
  r3.w = saturate(dot(-r4.xyz, cb0[17].xyz));
  ...
  r6.xyz = cb0[31].xyz * r3.www + r6.xyz;
  ...
  r3.w = dot(-r4.xyz, cb0[16].xyz);
  r6.xyz = cb0[11].xyz * r3.www + cb0[12].xyz;
  ...
  r7.xyz = r1.xyz * r0.www + cb0[17].xyz;
  r5.w = dot(r7.xyz, r7.xyz);
  r5.w = rsqrt(r5.w);
  r7.xyz = r7.xyz * r5.www;
  r5.w = saturate(dot(-r4.xyz, r7.xyz));
  r4.w = saturate(r4.w * 5 + 1);
  r5.w = log2(r5.w);
  r5.w = r5.w * r3.w;
  r5.w = exp2(r5.w);
  r4.w = r5.w * r4.w;
  r5.w = dot(r4.xyz, -cb0[18].xyz);
