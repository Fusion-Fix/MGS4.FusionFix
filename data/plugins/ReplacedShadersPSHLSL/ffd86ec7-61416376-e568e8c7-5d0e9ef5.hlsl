  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = r2.z * r0.w;
  r3.z = r1.w ? r0.w : 0;
  r2.zw = t2.Sample(s2_s, v4.zw).yw;
  r2.zw = float2(-0.5,-0.5) + r2.wz;
  r2.zw = cb0[1].zz * r2.zw;
  ...
  r3.xyz = cb0[15].xyz + -v10.xyz;
  r3.xyz = cb0[15].www * r3.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r3.xyz = cb0[18].xyz * r1.www;
  r3.xyz = cb0[16].xyz * r0.www + r3.xyz;
  ...
  r2.x = max(0, r2.x);
  r1.w = r2.x * r1.w;
  r2.x = dot(cb0[20].xyz, -r4.xyz);
  r0.w = r2.x / r0.w;
  r0.w = -cb0[24].w + r0.w;
  r0.w = saturate(cb0[23].w * r0.w);
  r2.xyz = cb0[24].xyz * r1.www;
