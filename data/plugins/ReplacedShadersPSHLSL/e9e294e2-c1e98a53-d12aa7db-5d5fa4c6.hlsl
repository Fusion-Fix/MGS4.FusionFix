  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = v6.xyz * r0.www + r3.xyz;
  r0.w = dot(r3.xyz, r3.xyz);
  r0.w = rsqrt(r0.w);
  r3.xyz = r3.xyz * r0.www;
  r0.w = dot(cb0[18].xyz, r3.xyz);
  r1.w = 1 / cb0[30].x;
  r2.w = r3.w * r1.w;
  r1.w = -r3.w * r1.w + 1;
  r3.w = saturate(v9.x);
  ...
  r2.w = dot(-r3.xyz, cb0[18].xyz);
  r3.w = dot(-r3.xyz, cb0[19].xyz);
  r4.w = saturate(dot(-r3.xyz, cb0[20].xyz));
  r6.xyz = r4.xyz * r1.www + cb0[18].xyz;
  r5.w = dot(r6.xyz, r6.xyz);
  r5.w = rsqrt(r5.w);
  r6.xyz = r6.xyz * r5.www;
  r5.w = saturate(dot(-r3.xyz, r6.xyz));
  r4.xyz = r4.xyz * r1.www + cb0[19].xyz;
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www;
  r1.w = saturate(dot(-r3.xyz, r4.xyz));
  r4.x = saturate(r2.w * 5 + 1);
  r4.y = log2(r5.w);
  r4.y = cb0[2].w * r4.y;
  r4.y = exp2(r4.y);
  r4.x = r4.y * r4.x;
  r4.y = saturate(r3.w * 5 + 1);
  r1.w = log2(r1.w);
  r1.w = cb0[2].w * r1.w;
  r1.w = exp2(r1.w);
  r1.w = r1.w * r4.y;
  ...
  r4.yzw = cb0[11].xyz * r4.www + r6.xyz;
  r0.w = r0.w * 0.75 + 0.25;
  r6.xyz = cb0[9].xyz * r0.www;
  r7.xyz = cb0[10].xyz * r1.www;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r7.xyz = cb0[34].xyz * r1.www;
  r7.xyz = cb0[32].xyz * r0.www + r7.xyz;
  r8.xyz = cb0[35].xyz + -v7.xyz;
  r8.xyz = cb0[35].www * r8.xyz;
  r0.w = dot(r8.xyz, r8.xyz);
  r0.w = sqrt(r0.w);
  r1.w = dot(r8.xyz, r3.xyz);
  r1.w = saturate(r1.w / r0.w);
  r2.w = 1 + -r0.w;
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[36].xyz, -r8.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[37].w + r0.w;
  r0.w = saturate(cb0[36].w * r0.w);
  r8.xyz = cb0[37].xyz * r1.www;
  ...
  r0.w = r2.w / r0.w;
  r0.w = -cb0[40].w + r0.w;
  r0.w = saturate(cb0[39].w * r0.w);
  r8.xyz = cb0[40].xyz * r1.www;
  r7.xyz = r8.xyz * r0.www + r7.xyz;
  r4.xyz = r7.xyz + r4.yzw;
  r0.w = dot(-r3.xyz, cb0[17].xyz);
