  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = float2(0.699999988,0.699999988) * cb0[28].xy;
  r0.zw = v7.xy / v7.ww;
  ...
  r3.xyw = v3.xyz * r3.xxx + r4.xyz;
  r0.xyz = r0.yzw * r3.zzz + r3.xyw;
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
  r0.xyz = r0.xyz * r0.www;
  r0.w = dot(cb0[17].xyz, r0.xyz);
  r3.x = 1 / cb0[29].x;
  r3.y = r3.x * r2.w;
  r2.w = -r2.w * r3.x + 1;
  r3.x = saturate(v8.x);
  ...
  r3.w = dot(-r0.xyz, cb0[17].xyz);
  r4.w = dot(-r0.xyz, cb0[18].xyz);
  r5.x = saturate(dot(-r0.xyz, cb0[19].xyz));
  r5.yzw = r3.xyz * r2.www + cb0[17].xyz;
  r6.x = dot(r5.yzw, r5.yzw);
  r6.x = rsqrt(r6.x);
  r5.yzw = r6.xxx * r5.yzw;
  r5.y = saturate(dot(-r0.xyz, r5.yzw));
  r3.xyz = r3.xyz * r2.www + cb0[18].xyz;
  r2.w = dot(r3.xyz, r3.xyz);
  r2.w = rsqrt(r2.w);
  ...
  r2.w = exp2(r2.w);
  r2.w = r2.w * r3.y;
  r5.yzw = cb0[8].xyz * r0.www;
  r3.w = saturate(r3.w);
  r4.w = saturate(r4.w);
  r6.xyz = cb0[9].xyz * r4.www;
  r3.yzw = r5.yzw * r3.www + r6.xyz;
  r3.yzw = cb0[10].xyz * r5.xxx + r3.yzw;
  r0.w = r0.w * 0.75 + 0.25;
  r5.xyz = cb0[8].xyz * r0.www;
  r6.xyz = cb0[9].xyz * r2.www;
