  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.y = max(0, r3.y);
  r3.y = r4.w * r3.y;
  r5.xyz = cb0[34].xyz * r3.yyy;
  r5.xyz = cb0[32].xyz * r2.www + r5.xyz;
  r6.xyz = cb0[35].xyz + -v6.xyz;
  r6.xyz = cb0[35].www * r6.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.y = r4.w * r3.y;
  r4.w = dot(cb0[36].xyz, -r6.xyz);
  r2.w = r4.w / r2.w;
  r2.w = -cb0[37].w + r2.w;
  r2.w = saturate(cb0[36].w * r2.w);
  r6.xyz = cb0[37].xyz * r3.yyy;
  r5.xyz = r6.xyz * r2.www + r5.xyz;
  r6.xyz = cb0[38].xyz + -v6.xyz;
  r6.xyz = cb0[38].www * r6.xyz;
  r2.w = dot(r6.xyz, r6.xyz);
  r2.w = sqrt(r2.w);
  r3.y = dot(r6.xyz, r0.xyz);
  r3.y = saturate(r3.y / r2.w);
  ...
  r2.w = r4.w / r2.w;
  r2.w = -cb0[40].w + r2.w;
  r2.w = saturate(cb0[39].w * r2.w);
  r6.xyz = cb0[40].xyz * r3.yyy;
  r5.xyz = r6.xyz * r2.www + r5.xyz;
