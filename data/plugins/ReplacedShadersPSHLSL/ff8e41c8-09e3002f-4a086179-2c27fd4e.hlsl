  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = dot(-r1.xyz, cb0[17].xyz);
  r3.w = dot(-r1.xyz, cb0[18].xyz);
  r4.w = saturate(dot(-r1.xyz, cb0[19].xyz));
  r5.xyz = r3.xyz * r1.www + cb0[17].xyz;
  r5.w = dot(r5.xyz, r5.xyz);
  r5.w = rsqrt(r5.w);
  r5.xyz = r5.xyz * r5.www;
  r5.x = saturate(dot(-r1.xyz, r5.xyz));
  r3.xyz = r3.xyz * r1.www + cb0[18].xyz;
  r1.w = dot(r3.xyz, r3.xyz);
  r1.w = rsqrt(r1.w);
  ...
  r2.w = saturate(r2.w);
  r3.w = saturate(r3.w);
  r3.yzw = cb0[9].xyz * r3.www;
  r3.yzw = r5.xyz * r2.www + r3.yzw;
  r3.yzw = cb0[10].xyz * r4.www + r3.yzw;
  r0.w = r0.w * 0.75 + 0.25;
  r5.xyz = cb0[8].xyz * r0.www;
