  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.w = max(0, r4.w);
  r4.w = r5.w * r4.w;
  r6.xyz = cb0[29].xyz * r4.www;
  r6.xyz = cb0[27].xyz * r3.www + r6.xyz;
  ...
  r5.w = max(0, r5.w);
  r4.w = r5.w * r4.w;
  r5.w = dot(cb0[31].xyz, -r7.xyz);
  r3.w = r5.w / r3.w;
  r3.w = -cb0[32].w + r3.w;
  r3.w = saturate(cb0[31].w * r3.w);
  r7.xyz = cb0[32].xyz * r4.www;
  ...
  r3.w = r5.w / r3.w;
  r3.w = -cb0[35].w + r3.w;
  r3.w = saturate(cb0[34].w * r3.w);
  r7.xyz = cb0[35].xyz * r4.www;
  r6.xyz = r7.xyz * r3.www + r6.xyz;
