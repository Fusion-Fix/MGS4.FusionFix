  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.x = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r4.z = r1.z * rotY + r2.y;
      r4.w = r2.z;
      r3.x = t2.SampleCmpLevelZero(s2_s, r4.yz, r4.w).x;
      r3.w = r3.x + r3.w;
    }
  }
  r0.w = v1.w * r0.w;
  ...
  r3.xyz = v6.xyz * r2.xxx + r3.xyz;
  r3.xyz = v8.xyz * r2.zzz + r3.xyz;
