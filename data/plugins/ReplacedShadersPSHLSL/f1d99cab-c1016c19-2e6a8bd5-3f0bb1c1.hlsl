  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = cmp(r2.w < 0);
  r2.w = r2.w ? r3.x : 0;
  r3.x = saturate(dot(-cb0[10].xyz, r2.xyz));
  r3.yzw = cb0[9].xyz * r2.www;
  r1.xyz = r3.yzw * r3.xxx + r1.xyz;
  ...
  r3.y = max(0, r3.y);
  r3.x = r3.x * r3.y;
  r3.yzw = cb0[19].xyz + -v10.xyz;
  r3.yzw = cb0[19].www * r3.yzw;
  r4.x = dot(r3.yzw, r3.yzw);
  r4.x = sqrt(r4.x);
  r3.y = dot(r3.yzw, r2.xyz);
  r3.y = saturate(r3.y / r4.x);
  r3.z = 1 + -r4.x;
  r3.z = max(0, r3.z);
  r3.y = r3.y * r3.z;
  r3.yzw = cb0[20].xyz * r3.yyy;
  r3.xyz = cb0[18].xyz * r3.xxx + r3.yzw;
  ...
  r3.w = r4.x / r3.w;
  r3.w = -cb0[23].w + r3.w;
  r3.w = saturate(cb0[22].w * r3.w);
  r4.xyz = cb0[23].xyz * r4.www;
  ...
  r3.w = r4.x / r3.w;
  r3.w = -cb0[26].w + r3.w;
  r3.w = saturate(cb0[25].w * r3.w);
  r4.xyz = cb0[26].xyz * r4.www;
  r3.xyz = r4.xyz * r3.www + r3.xyz;
