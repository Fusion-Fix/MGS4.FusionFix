  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = r4.w * r1.w;
  r1.w = r4.z ? r1.w : 0;
  r4.z = t5.Sample(s5_s, w2.xy).y;
  r4.z = cb0[2].w * r4.z;
  r5.xyz = v4.xyz * r4.yyy;
  r4.xyw = v3.xyz * r4.xxx + r5.xyz;
  r4.xyw = v5.xyz * r1.www + r4.xyw;
  r1.w = dot(r4.xyw, r4.xyw);
  r1.w = rsqrt(r1.w);
  r4.xyw = r4.xyw * r1.www;
  r1.w = dot(cb0[17].xyz, r4.xyw);
  r5.x = 1 / cb0[29].x;
  r5.y = r5.x * r2.w;
  r2.w = -r2.w * r5.x + 1;
  r5.x = saturate(v8.x);
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r2.w : 0;
  r2.w = saturate(dot(-r4.xyw, cb0[17].xyz));
  r5.x = saturate(dot(-r4.xyw, cb0[18].xyz));
  r5.y = saturate(dot(-r4.xyw, cb0[19].xyz));
  r6.xyz = cb0[8].xyz * r1.www;
  r5.xzw = cb0[9].xyz * r5.xxx;
  r5.xzw = r6.xyz * r2.www + r5.xzw;
  r5.xyz = cb0[10].xyz * r5.yyy + r5.xzw;
  r6.xyz = cb0[30].xyz + -v6.xyz;
  r6.xyz = cb0[30].www * r6.xyz;
  r2.w = dot(r6.xyz, r6.xyz);
  r2.w = sqrt(r2.w);
  r5.w = dot(r6.xyz, r4.xyw);
  r5.w = saturate(r5.w / r2.w);
  r2.w = 1 + -r2.w;
  r2.w = max(0, r2.w);
  r2.w = r5.w * r2.w;
  r6.xyz = cb0[32].xyz + -v6.xyz;
  r6.xyz = cb0[32].www * r6.xyz;
  r5.w = dot(r6.xyz, r6.xyz);
  r5.w = sqrt(r5.w);
  r6.x = dot(r6.xyz, r4.xyw);
  r6.x = saturate(r6.x / r5.w);
  r5.w = 1 + -r5.w;
  r5.w = max(0, r5.w);
  r5.w = r6.x * r5.w;
  r6.xyz = cb0[33].xyz * r5.www;
  r6.xyz = cb0[31].xyz * r2.www + r6.xyz;
  r7.xyz = cb0[34].xyz + -v6.xyz;
  r7.xyz = cb0[34].www * r7.xyz;
  r2.w = dot(r7.xyz, r7.xyz);
  r2.w = sqrt(r2.w);
  r5.w = dot(r7.xyz, r4.xyw);
  r5.w = saturate(r5.w / r2.w);
  r6.w = 1 + -r2.w;
  r6.w = max(0, r6.w);
  r5.w = r6.w * r5.w;
  r6.w = dot(cb0[35].xyz, -r7.xyz);
  r2.w = r6.w / r2.w;
  r2.w = -cb0[36].w + r2.w;
  r2.w = saturate(cb0[35].w * r2.w);
  r7.xyz = cb0[36].xyz * r5.www;
  r6.xyz = r7.xyz * r2.www + r6.xyz;
  r7.xyz = cb0[37].xyz + -v6.xyz;
  ...
  r2.w = r6.w / r2.w;
  r2.w = -cb0[39].w + r2.w;
  r2.w = saturate(cb0[38].w * r2.w);
  r7.xyz = cb0[39].xyz * r5.www;
  r6.xyz = r7.xyz * r2.www + r6.xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r2.w = dot(-r4.xyw, cb0[16].xyz);
  ...
  r2.w = r4.z * r2.w + cb0[1].w;
  r2.w = v1.y * -r2.w + r2.w;
  r5.w = 1 + v1.y;
  r6.xyz = r6.xyz * r5.www;
  r5.w = dot(r4.xyw, -cb0[17].xyz);
  r7.xyz = r0.xyz * r0.www + cb0[17].xyz;
  r6.w = dot(r7.xyz, r7.xyz);
  r6.w = rsqrt(r6.w);
  r7.xyz = r7.xyz * r6.www;
  r6.w = saturate(dot(-r4.xyw, r7.xyz));
  r5.w = saturate(r5.w * 5 + 1);
  r6.w = log2(r6.w);
  r6.w = r6.w * r2.w;
  r6.w = exp2(r6.w);
  r5.w = r6.w * r5.w;
  r6.w = dot(r4.xyw, -cb0[18].xyz);
  r0.xyz = r0.xyz * r0.www + cb0[18].xyz;
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
  r0.xyz = r0.xyz * r0.www;
  r0.x = saturate(dot(-r4.xyw, r0.xyz));
  ...
  r1.x = cb0[18].w * r1.x;
  r1.x = r1.y ? 0 : r1.x;
  r3.xyz = t4.Sample(s4_s, w2.xy).xyz;
  r0.yzw = r1.xxx * r3.xyz + r0.yzw;
  r4.x = r5.w * 0.939999998 + 0.0500000007;
