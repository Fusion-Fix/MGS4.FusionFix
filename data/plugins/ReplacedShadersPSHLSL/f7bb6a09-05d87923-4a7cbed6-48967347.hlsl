  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = cmp(v0.x < 512);
  if (r0.x == 0) discard;
  r0.y = dot(v10.xyz, v10.xyz);
  r0.y = rsqrt(r0.y);
  r0.yzw = v10.xyz * r0.yyy;
  ...
  r1.xyz = r1.xyz * r4.xyz + r0.yzw;
  r1.xyz = r0.yzw * r2.www + r1.xyz;
  r1.w = v1.w * r1.w;
  r1.w = cb0[3].x * r1.w;
  r1.w = r1.w * r3.x;
  r2.xy = v0.xy / cb0[11].xy;
  r2.xy = r1.ww * float2(0.150000006,0.150000006) + r2.xy;
  r2.xyz = t5.Sample(s5_s, r2.xy).xyz;
  r2.xyz = float3(0.25,0.25,0.25) * r2.xyz;
  r3.xyz = cmp(v0.xxx < float3(128,256,384));
  r0.yzw = r3.zzz ? r0.yzw : r2.xyz;
  r0.yzw = r3.yyy ? r4.xyz : r0.yzw;
  r0.yzw = r3.xxx ? r1.xyz : r0.yzw;
  r1.x = cmp(736 < v0.y);
  r0.yzw = r1.xxx ? float3(0,0,0.5) : r0.yzw;
