  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.x = cmp(r2.x < 0);
  r2.x = r2.x ? r2.y : 0;
  r2.y = saturate(dot(-cb0[10].xyz, r3.xyz));
  r4.xyz = cb0[9].xyz * r2.xxx;
  r1.xyz = r4.xyz * r2.yyy + r1.xyz;
  r2.yzw = cb0[17].xyz + -v10.xyz;
  r2.yzw = cb0[17].www * r2.yzw;
  ...
  r2.w = saturate(r2.w / r2.z);
  r2.z = 1 + -r2.z;
  r2.z = max(0, r2.z);
  r2.z = r2.w * r2.z;
  r4.xyz = cb0[20].xyz * r2.zzz;
  r2.yzw = cb0[18].xyz * r2.yyy + r4.xyz;
  ...
  r2.yzw = t4.Sample(s4_s, r2.yzw).xyz;
