  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = saturate(dot(-r2.xyz, cb0[18].xyz));
  r2.w = saturate(dot(-r2.xyz, cb0[19].xyz));
  r3.w = saturate(dot(-r2.xyz, cb0[20].xyz));
  r4.xyz = cb0[9].xyz * r0.www;
  r5.xyz = cb0[10].xyz * r2.www;
  r4.xyz = r4.xyz * r1.www + r5.xyz;
  r4.xyz = cb0[11].xyz * r3.www + r4.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r5.xyz = cb0[34].xyz * r1.www;
  r5.xyz = cb0[32].xyz * r0.www + r5.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[36].xyz, -r6.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[37].w + r0.w;
  r0.w = saturate(cb0[36].w * r0.w);
  r6.xyz = cb0[37].xyz * r1.www;
  ...
  r6.xyz = cb0[40].xyz * r1.www;
  r5.xyz = r6.xyz * r0.www + r5.xyz;
  r4.xyz = r5.xyz + r4.xyz;
  r0.w = dot(-r2.xyz, cb0[17].xyz);
  r5.xyz = cb0[12].xyz * r0.www + cb0[13].xyz;
