  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.w * r2.w;
  r6.xyz = cb0[30].xyz * r2.www;
  r6.xyz = cb0[28].xyz * r1.www + r6.xyz;
  r7.xyz = cb0[31].xyz + -v9.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[32].xyz, -r7.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[33].w + r1.w;
  r1.w = saturate(cb0[32].w * r1.w);
  r7.xyz = cb0[33].xyz * r2.www;
