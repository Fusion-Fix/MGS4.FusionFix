  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.w = saturate(dot(-r2.xyz, cb0[19].xyz));
  ...
  r5.xyz = cb0[12].xyz * r1.www + cb0[13].xyz;
  r5.xyz = cb0[2].xyz * r5.xyz;
  r4.xyz = r4.xyz * cb0[1].xyz + r5.xyz;
  r5.xyz = t4.Sample(s4_s, w2.xy).xyz;
  ...
  r1.w = cb0[22].w * r1.w;
  r0.xyz = -r0.xyz * r4.xyz + cb0[22].xyz;
