  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r5.w = max(0, r5.w);
  r5.w = r6.x * r5.w;
  r6.xyz = cb0[29].xyz * r5.www;
  r6.xyz = cb0[27].xyz * r2.www + r6.xyz;
  ...
  r6.w = max(0, r6.w);
  r5.w = r6.w * r5.w;
  r6.w = dot(cb0[31].xyz, -r7.xyz);
  r2.w = r6.w / r2.w;
  r2.w = -cb0[32].w + r2.w;
  r2.w = saturate(cb0[31].w * r2.w);
  r7.xyz = cb0[32].xyz * r5.www;
  ...
  r2.w = r6.w / r2.w;
  r2.w = -cb0[35].w + r2.w;
  r2.w = saturate(cb0[34].w * r2.w);
  r7.xyz = cb0[35].xyz * r5.www;
  r6.xyz = r7.xyz * r2.www + r6.xyz;
