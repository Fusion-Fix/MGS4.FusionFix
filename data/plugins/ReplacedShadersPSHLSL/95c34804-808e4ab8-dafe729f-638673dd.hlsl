  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r5.zw = r5.zw + r5.zw;
  r3.w = t7.Sample(s7_s, w2.xy).y;
  r3.w = cb0[2].w * r3.w;
  r5.xy = r5.zw * r3.ww + r5.xy;
  ...
  r7.xyz = cb0[31].xyz * r2.www + r7.xyz;
  ...
  r8.xzw = cb0[37].xyz + -v7.xyz;
  r8.xzw = cb0[37].www * r8.xzw;
  r4.w = dot(r8.xzw, r8.xzw);
  r4.w = sqrt(r4.w);
  r5.w = dot(r8.xzw, r5.xyz);
  r5.w = saturate(r5.w / r4.w);
  r6.w = 1 + -r4.w;
  r6.w = max(0, r6.w);
  r5.w = r6.w * r5.w;
  r6.w = dot(cb0[35].xyz, -r8.xzw);
  r4.w = r6.w / r4.w;
  r4.w = -cb0[39].w + r4.w;
  r4.w = saturate(cb0[38].w * r4.w);
  r8.xzw = cb0[39].xyz * r5.www;
  r5.w = r8.z * r4.w;
  r7.xyz = r8.xzw * r4.www + r7.xyz;
  r6.xyz = r7.xyz + r6.xyz;
  r4.w = dot(-r5.xyz, cb0[16].xyz);
  r7.xyz = cb0[11].xyz * r4.www + cb0[12].xyz;
  r7.xyz = cb0[1].xyz * r7.xyz;
  r6.xyz = r6.xyz * cb0[0].xyz + r7.xyz;
  r7.xyz = float3(-1,-1,-1) + cb0[3].xyz;
  r7.xyz = r3.www * r7.xyz + float3(1,1,1);
  r4.w = cb0[3].w + -cb0[1].w;
  r4.w = r3.w * r4.w + cb0[1].w;
  r4.w = v1.y * -r4.w + r4.w;
  r6.w = 1 + v1.y;
  r7.xyz = r7.xyz * r6.www;
  r6.w = dot(r5.xyz, -cb0[17].xyz);
  r8.xzw = r0.xyz * r0.www + cb0[17].xyz;
  r7.w = dot(r8.xzw, r8.xzw);
  r7.w = rsqrt(r7.w);
  r8.xzw = r8.xzw * r7.www;
  r7.w = saturate(dot(-r5.xyz, r8.xzw));
  r6.w = saturate(r6.w * 5 + 1);
  r7.w = log2(r7.w);
  r7.w = r7.w * r4.w;
  r7.w = exp2(r7.w);
  r6.w = r7.w * r6.w;
  r7.w = dot(r5.xyz, -cb0[18].xyz);
  r0.xyz = r0.xyz * r0.www + cb0[18].xyz;
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
  r0.xyz = r0.xyz * r0.www;
  r0.x = saturate(dot(-r5.xyz, r0.xyz));
  r0.y = saturate(r7.w * 5 + 1);
  r0.x = log2(r0.x);
  r0.x = r4.w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r0.y;
  r0.yzw = r3.xyz * cb0[2].xyz + -r2.xyz;
  ...
  r3.x = r6.w * 0.939999998 + 0.0500000007;
