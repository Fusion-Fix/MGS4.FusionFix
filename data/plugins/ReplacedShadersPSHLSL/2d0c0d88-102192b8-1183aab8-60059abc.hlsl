  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = cb0[4].xxx * r2.xyz + r1.xyz;
  ...
  r2.xyz = cb0[4].xxx * r3.xyz + r2.xyz;
  r3.xyz = v5.xyz * r2.yyy;
  r2.xyw = v4.xyz * r2.xxx + r3.xyz;
  r2.xyz = v6.xyz * r2.zzz + r2.xyw;
  ...
  r4.x = dot(-r2.xyz, cb0[19].xyz);
  r4.y = saturate(dot(-r2.xyz, cb0[20].xyz));
  r5.xyz = r3.xyz * r2.www + cb0[18].xyz;
  r4.z = dot(r5.xyz, r5.xyz);
  r4.z = rsqrt(r4.z);
  r5.xyz = r5.xyz * r4.zzz;
  r4.z = saturate(dot(-r2.xyz, r5.xyz));
  ...
  r3.yzw = r5.xyz * r3.www + r4.xzw;
  r3.yzw = cb0[11].xyz * r4.yyy + r3.yzw;
  r1.w = r1.w * 0.75 + 0.25;
  r4.xyz = cb0[9].xyz * r1.www;
  r5.xyz = cb0[10].xyz * r2.www;
  r4.xyz = r3.xxx * r4.xyz + r5.xyz;
  r5.xyz = cb0[27].xyz + -v7.xyz;
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.x * r2.w;
  r5.xyz = cb0[30].xyz * r2.www;
  r5.xyz = cb0[28].xyz * r1.www + r5.xyz;
  r6.xyz = cb0[31].xyz + -v7.xyz;
  ...
  r3.x = max(0, r3.x);
  r2.w = r3.x * r2.w;
  r3.x = dot(cb0[32].xyz, -r6.xyz);
  r1.w = r3.x / r1.w;
  r1.w = -cb0[33].w + r1.w;
  r1.w = saturate(cb0[32].w * r1.w);
  r6.xyz = cb0[33].xyz * r2.www;
  r5.xyz = r6.xyz * r1.www + r5.xyz;
  r6.xyz = cb0[34].xyz + -v7.xyz;
  ...
  r6.xyz = cb0[36].xyz * r2.www;
  r5.xyz = r6.xyz * r1.www + r5.xyz;
  r3.xyz = r5.xyz + r3.yzw;
  r1.w = dot(-r2.xyz, cb0[17].xyz);
  r2.xyz = cb0[12].xyz * r1.www + cb0[13].xyz;
  r2.xyz = cb0[2].xyz * r2.xyz;
  r2.xyz = r3.xyz * cb0[1].xyz + r2.xyz;
