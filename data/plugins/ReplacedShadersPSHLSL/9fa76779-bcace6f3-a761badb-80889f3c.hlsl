  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = 1 + v1.y;
  r3.xyz = cb0[4].xyz * r2.www;
  r2.w = dot(r0.xzw, -cb0[18].xyz);
  r3.w = saturate(dot(-r0.xzw, r5.xyz));
  ...
  r3.w = r2.w * r7.x;
  r3.w = r3.w * 3.5 + -r2.w;
  r2.w = r3.w * 0.400000006 + r2.w;
  r3.w = 3.5 * r6.x;
  r2.w = saturate(max(r3.w, r2.w));
  ...
  r2.w = dot(r0.xzw, -cb0[19].xyz);
  r0.x = saturate(dot(-r0.xzw, r2.xyz));
  r0.z = saturate(r2.w * 5 + 1);
  r0.x = log2(r0.x);
  r0.x = r1.w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r0.z;
  r0.z = r0.x * r7.x;
  r0.z = r0.z * 3.5 + -r0.x;
  r0.x = saturate(r0.z * 0.400000006 + r0.x);
  r4.z = r0.x * 0.939999998 + 0.0500000007;
  r0.xzw = t3.Sample(s3_s, r4.zw).xyz;
  r0.xzw = cb0[10].xyz * r0.xzw;
  r0.xzw = float3(0.300000012,0.300000012,0.300000012) * r0.xzw;
  r0.xzw = max(float3(0,0,0), r0.xzw);
  r0.xzw = r0.xzw * r3.xyz;
  r0.xzw = cb0[5].www * r0.xzw + r1.xyz;
