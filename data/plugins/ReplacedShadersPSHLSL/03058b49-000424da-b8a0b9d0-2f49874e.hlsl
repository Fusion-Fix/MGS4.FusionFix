  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = cb0[4].www * r2.xyz + r1.xyz;
  ...
  r0.y = dot(-r3.xyz, cb0[16].xyz);
  r8.xyz = cb0[11].xyz * r0.yyy + cb0[12].xyz;
  r9.xyz = cb0[1].xyz * r8.xyz;
  r4.xyz = r4.xyz * cb0[0].xyz + r9.xyz;
  r0.y = dot(r3.xyz, -cb0[17].xyz);
  r0.w = saturate(r0.y);
  ...
  r0.y = saturate(r0.y * 5 + 1);
  r0.z = cb0[3].w * r0.z;
  r0.z = exp2(r0.z);
  r0.y = r0.z * r0.y;
  r5.x = r0.y * 0.939999998 + 0.0500000007;
  r5.yw = float2(0.5,0.5);
  r0.yzw = t4.Sample(s4_s, r5.xy).xyz;
  r6.xyz = r6.xyz * r2.xyz;
  r0.yzw = r6.xyz * r0.yzw;
  r0.yzw = max(float3(0,0,0), r0.yzw);
  r6.xyz = r7.xyz * r2.xyz;
  r3.xyz = max(r6.xyz, r3.xyz);
  r0.yzw = r0.yzw * cb0[3].xyz + -r3.xyz;
  r0.yzw = cb0[4].www * r0.yzw + r3.xyz;
  r0.yzw = r1.xyz * r4.xyz + r0.yzw;
  r1.x = saturate(r2.w * 5 + 1);
  r0.x = cb0[3].w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r1.x;
  r5.z = r0.x * 0.939999998 + 0.0500000007;
  r1.xyz = t4.Sample(s4_s, r5.zw).xyz;
  r2.xyz = cb0[9].xyz * r2.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r1.xyz = max(float3(0,0,0), r1.xyz);
  r1.xyz = cb0[3].xyz * r1.xyz;
  r0.xyz = cb0[4].www * r1.xyz + r0.yzw;
