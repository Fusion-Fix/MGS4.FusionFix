  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = r1.w * r0.w;
  r0.w = r1.z ? r0.w : 0;
  r1.zw = cb0[2].xy * v3.zw;
  r1.zw = t2.Sample(s2_s, r1.zw).yw;
  r1.zw = float2(-0.5,-0.5) + r1.wz;
  r1.zw = cb0[2].zz * r1.zw;
  r1.xy = r1.zw * float2(2,2) + r1.xy;
  r1.yzw = v4.xyz * r1.yyy;
  r1.xyz = w2.xyz * r1.xxx + r1.yzw;
  r1.xyz = v5.xyz * r0.www + r1.xyz;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  r0.w = dot(cb0[17].xyz, r1.xyz);
  r1.w = 1 / cb0[24].x;
  r2.x = r3.w * r1.w;
  r1.w = -r3.w * r1.w + 1;
  r2.y = saturate(v8.x);
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r1.w : 0;
  r1.w = saturate(dot(-r1.xyz, cb0[17].xyz));
  r2.x = saturate(dot(-r1.xyz, cb0[18].xyz));
  r2.y = saturate(dot(-r1.xyz, cb0[19].xyz));
  r3.xyz = cb0[8].xyz * r0.www;
  r2.xzw = cb0[9].xyz * r2.xxx;
  r2.xzw = r3.xyz * r1.www + r2.xzw;
  r2.xyz = cb0[10].xyz * r2.yyy + r2.xzw;
  r3.xyz = cb0[25].xyz + -v6.xyz;
  r3.xyz = cb0[25].www * r3.xyz;
  ...
  r0.w = max(0, r0.w);
  r0.w = r1.w * r0.w;
  r3.xyz = cb0[27].xyz + -v6.xyz;
  r3.xyz = cb0[27].www * r3.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r3.xyz = cb0[28].xyz * r1.www;
  r3.xyz = cb0[26].xyz * r0.www + r3.xyz;
  r4.xyz = cb0[29].xyz + -v6.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[30].xyz, -r4.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[31].w + r0.w;
  r0.w = saturate(cb0[30].w * r0.w);
  r4.xyz = cb0[31].xyz * r1.www;
  r3.xyz = r4.xyz * r0.www + r3.xyz;
  r4.xyz = cb0[32].xyz + -v6.xyz;
  r4.xyz = cb0[32].www * r4.xyz;
  r0.w = dot(r4.xyz, r4.xyz);
  r0.w = sqrt(r0.w);
  r1.w = dot(r4.xyz, r1.xyz);
  r1.w = saturate(r1.w / r0.w);
  ...
  r0.w = r2.w / r0.w;
  r0.w = -cb0[34].w + r0.w;
  r0.w = saturate(cb0[33].w * r0.w);
  r4.xyz = cb0[34].xyz * r1.www;
  r3.xyz = r4.xyz * r0.www + r3.xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r0.w = dot(-r1.xyz, cb0[16].xyz);
  r1.xyz = cb0[11].xyz * r0.www + cb0[12].xyz;
  r1.xyz = cb0[1].xyz * r1.xyz;
  r1.xyz = r2.xyz * cb0[0].xyz + r1.xyz;
