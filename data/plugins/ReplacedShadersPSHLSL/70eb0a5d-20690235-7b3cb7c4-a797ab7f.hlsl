  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.z = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r4.y = r0.z * rotY + r2.y;
      r4.w = r2.z;
      r3.w = t4.SampleCmpLevelZero(s4_s, r4.xy, r4.w).x;
      r3.y = r3.w + r3.y;
    }
  }
  r0.y = v1.w * r1.w;
  r0.y = cmp(r0.y < 0.498039216);
  if (r0.y != 0) discard;
  r0.xyz = v5.xyz * r0.xxx;
  r2.xyz = -cb0[23].xyz + v6.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = rsqrt(r0.w);
  r3.xzw = r2.xyz * r0.www;
  r4.xyz = cb0[5].xyz + -r1.xyz;
  r1.xyz = cb0[5].www * r4.xyz + r1.xyz;
  r1.w = dot(r0.xyz, r0.xyz);
  r1.w = rsqrt(r1.w);
  r0.xyz = r1.www * r0.xyz;
  r1.w = dot(cb0[18].xyz, r0.xyz);
  r2.w = 1 / cb0[30].x;
  r4.x = r3.y * r2.w;
  r2.w = -r3.y * r2.w + 1;
  r3.y = saturate(v8.x);
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r2.w : 0;
  r2.w = saturate(dot(-r0.xyz, cb0[18].xyz));
  r3.y = saturate(dot(-r0.xyz, cb0[19].xyz));
  r4.x = saturate(dot(-r0.xyz, cb0[20].xyz));
  r4.yzw = cb0[9].xyz * r1.www;
  r5.xyz = cb0[10].xyz * r3.yyy;
  r4.yzw = r4.yzw * r2.www + r5.xyz;
  r4.xyz = cb0[11].xyz * r4.xxx + r4.yzw;
  r2.w = dot(-r0.xyz, cb0[17].xyz);
  r5.xyz = cb0[12].xyz * r2.www + cb0[13].xyz;
  r5.xyz = cb0[2].xyz * r5.xyz;
  r4.xyz = r4.xyz * cb0[1].xyz + r5.xyz;
  r5.xyz = r2.xyz * r0.www + cb0[18].xyz;
  r2.w = dot(r5.xyz, r5.xyz);
  r2.w = rsqrt(r2.w);
  r5.xyz = r5.xyz * r2.www;
  r2.xyz = r2.xyz * r0.www + cb0[19].xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = rsqrt(r0.w);
  r2.xyz = r2.xyz * r0.www;
  r0.w = dot(-v4.xyz, -v4.xyz);
  r0.w = rsqrt(r0.w);
  r6.xyz = -v4.xyz * r0.www;
  ...
  r2.w = exp2(r2.w);
  r0.w = r2.w * r0.w;
  r7.xyz = t1.Sample(s1_s, v3.xy).xyz;
  r8.xyz = r7.xyz * r0.www;
  r8.xyz = v3.zzz * r8.xyz;
  r0.w = r1.w * 0.75 + 0.25;
  r9.xyz = cb0[9].xyz * r0.www;
  ...
  r3.xyz = cb0[5].www * -r6.xyz + r6.xyz;
  r1.xyz = r1.xyz * r4.xyz + r3.xyz;
  r0.w = v1.y * -cb0[4].w + cb0[4].w;
  r1.w = 1 + v1.y;
  r3.xyz = cb0[4].xyz * r1.www;
  r1.w = dot(r0.xyz, -cb0[18].xyz);
  ...
  r2.w = r1.w * r7.x;
  r2.w = r2.w * 3.5 + -r1.w;
  r1.w = r2.w * 0.400000006 + r1.w;
  r2.w = 3.5 * r6.x;
  r1.w = saturate(max(r2.w, r1.w));
  r4.x = r1.w * 0.939999998 + 0.0500000007;
  ...
  r1.xyz = cb0[5].www * r5.xyz + r1.xyz;
  r1.w = dot(r0.xyz, -cb0[19].xyz);
  r0.x = saturate(dot(-r0.xyz, r2.xyz));
  r0.y = saturate(r1.w * 5 + 1);
  r0.x = log2(r0.x);
  r0.x = r0.w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r0.y;
  r0.y = r0.x * r7.x;
  r0.y = r0.y * 3.5 + -r0.x;
  r0.x = saturate(r0.y * 0.400000006 + r0.x);
  r4.z = r0.x * 0.939999998 + 0.0500000007;
  r0.xyz = t3.Sample(s3_s, r4.zw).xyz;
  r0.xyz = cb0[10].xyz * r0.xyz;
  r0.xyz = float3(0.300000012,0.300000012,0.300000012) * r0.xyz;
  r0.xyz = max(float3(0,0,0), r0.xyz);
  r0.xyz = r0.xyz * r3.xyz;
  r0.xyz = cb0[5].www * r0.xyz + r1.xyz;
