  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r1.w : 0;
  r1.w = saturate(dot(-cb0[10].xyz, r3.xyz));
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.x * r1.w;
  r2.xyz = cb0[19].xyz + -v10.xyz;
  r2.xyz = cb0[19].www * r2.xyz;
  ...
  r2.y = max(0, r2.y);
  r2.x = r2.x * r2.y;
  r2.xyz = cb0[20].xyz * r2.xxx;
  r2.xyz = cb0[18].xyz * r1.www + r2.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[22].xyz, -r4.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[23].w + r1.w;
  r1.w = saturate(cb0[22].w * r1.w);
  r4.xyz = cb0[23].xyz * r2.www;
  ...
  r1.w = r3.w / r1.w;
  r1.w = -cb0[26].w + r1.w;
  r1.w = saturate(cb0[25].w * r1.w);
  r4.xyz = cb0[26].xyz * r2.www;
  r2.xyz = r4.xyz * r1.www + r2.xyz;
