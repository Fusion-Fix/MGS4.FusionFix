  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = exp2(r1.x);
  r1.xz = r1.xz * r1.yy;
  r6.x = r1.x * 0.939999998 + 0.0500000007;
  r6.yw = float2(0.5,0.5);
  r1.xyw = t5.Sample(s5_s, r6.xy).xyz;
  r3.w = r3.w * 0.75 + 0.25;
  r7.xyz = cb0[9].xyz * r3.www;
  r8.xyz = cb0[4].xyz * r7.xyz;
  r8.xyz = r8.xyz * r1.xyw;
  r9.xyz = cb0[10].xyz * cb0[4].xyz;
  r1.xyw = r9.xyz * r1.xyw;
  r6.z = r4.w * 0.939999998 + 0.0500000007;
  r6.xyz = t3.Sample(s3_s, r6.zw).xyz;
  r9.x = r1.z * 0.939999998 + 0.0500000007;
  r9.y = 0.5;
  r9.xyz = t3.Sample(s3_s, r9.xy).xyz;
