  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = r1.w * r0.w;
  r0.w = r1.z ? r0.w : 0;
  r1.zw = cb0[3].xy * v3.xy;
  r1.zw = t2.Sample(s2_s, r1.zw).yw;
  r1.zw = float2(-0.5,-0.5) + r1.wz;
  r1.zw = cb0[3].zz * r1.zw;
  r1.xy = r1.zw * float2(2,2) + r1.xy;
  r1.yzw = v5.xyz * r1.yyy;
  r1.xyz = v4.xyz * r1.xxx + r1.yzw;
  r1.xyz = v6.xyz * r0.www + r1.xyz;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  r0.w = dot(cb0[18].xyz, r1.xyz);
  r1.w = 1 / cb0[26].x;
  r2.x = r3.w * r1.w;
  r1.w = -r3.w * r1.w + 1;
  r2.y = saturate(v9.x);
  ...
  r1.w = saturate(dot(-r1.xyz, cb0[18].xyz));
  r2.w = saturate(dot(-r1.xyz, cb0[19].xyz));
  r3.x = saturate(dot(-r1.xyz, cb0[20].xyz));
  r3.yzw = cb0[9].xyz * r0.www;
  r4.xyz = cb0[10].xyz * r2.www;
  r3.yzw = r3.yzw * r1.www + r4.xyz;
  r3.xyz = cb0[11].xyz * r3.xxx + r3.yzw;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r4.xyz = cb0[30].xyz * r1.www;
  r4.xyz = cb0[28].xyz * r0.www + r4.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[32].xyz, -r5.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[33].w + r0.w;
  r0.w = saturate(cb0[32].w * r0.w);
  r5.xyz = cb0[33].xyz * r1.www;
  ...
  r5.xyz = cb0[36].xyz * r1.www;
  r4.xyz = r5.xyz * r0.www + r4.xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r0.w = dot(-r1.xyz, cb0[17].xyz);
  r4.xyz = cb0[12].xyz * r0.www + cb0[13].xyz;
