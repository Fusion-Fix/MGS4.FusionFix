  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.xyz = cb0[32].xyz * r0.www + r4.xyz;
  r5.xyz = cb0[35].xyz + -v6.xyz;
  r5.xyz = cb0[35].www * r5.xyz;
  ...
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[36].xyz, -r5.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[37].w + r0.w;
  r0.w = saturate(cb0[36].w * r0.w);
  r5.xyz = cb0[37].xyz * r1.www;
  r4.xyz = r5.xyz * r0.www + r4.xyz;
  r5.xyz = cb0[38].xyz + -v6.xyz;
  r5.xyz = cb0[38].www * r5.xyz;
  r0.w = dot(r5.xyz, r5.xyz);
  r0.w = sqrt(r0.w);
  r1.w = dot(r5.xyz, r1.xyz);
  r1.w = saturate(r1.w / r0.w);
