  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r5.xyz = cb0[27].xyz + -v6.xyz;
  r5.xyz = cb0[27].www * r5.xyz;
  r2.w = dot(r5.xyz, r5.xyz);
  r2.w = sqrt(r2.w);
  r3.y = dot(r5.xyz, r0.xyz);
  r3.y = saturate(r3.y / r2.w);
  r2.w = 1 + -r2.w;
  r2.w = max(0, r2.w);
  r2.w = r3.y * r2.w;
  r5.xyz = cb0[29].xyz + -v6.xyz;
  r5.xyz = cb0[29].www * r5.xyz;
  r3.y = dot(r5.xyz, r5.xyz);
  r3.y = sqrt(r3.y);
  r4.w = dot(r5.xyz, r0.xyz);
  r4.w = saturate(r4.w / r3.y);
  r3.y = 1 + -r3.y;
  r3.y = max(0, r3.y);
  r3.y = r4.w * r3.y;
  r5.xyz = cb0[30].xyz * r3.yyy;
  r5.xyz = cb0[28].xyz * r2.www + r5.xyz;
  r6.xyz = cb0[31].xyz + -v6.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.y = r4.w * r3.y;
  r4.w = dot(cb0[32].xyz, -r6.xyz);
  r2.w = r4.w / r2.w;
  r2.w = -cb0[33].w + r2.w;
  r2.w = saturate(cb0[32].w * r2.w);
  r6.xyz = cb0[33].xyz * r3.yyy;
  r5.xyz = r6.xyz * r2.www + r5.xyz;
  r6.xyz = cb0[34].xyz + -v6.xyz;
  r6.xyz = cb0[34].www * r6.xyz;
  r2.w = dot(r6.xyz, r6.xyz);
  r2.w = sqrt(r2.w);
  r3.y = dot(r6.xyz, r0.xyz);
  r3.y = saturate(r3.y / r2.w);
