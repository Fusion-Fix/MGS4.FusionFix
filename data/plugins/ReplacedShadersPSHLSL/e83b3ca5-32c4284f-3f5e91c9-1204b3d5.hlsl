  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = r3.x * r0.w;
  r3.z = r2.z ? r0.w : 0;
  r4.xy = cb0[3].xy * v3.zw;
  r4.xy = t5.Sample(s5_s, r4.xy).yw;
  r4.xy = float2(-0.5,-0.5) + r4.yx;
  r4.xy = cb0[3].zz * r4.xy;
  r3.xy = r4.xy * float2(2,2) + r2.xy;
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r2.w : 0;
  r2.w = saturate(dot(-cb0[10].xyz, r2.xyz));
  ...
  r3.y = max(0, r3.y);
  r3.x = r3.x * r3.y;
  r3.xyz = cb0[20].xyz * r3.xxx;
  r3.xyz = cb0[18].xyz * r2.www + r3.xyz;
