  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = v1.y * -cb0[1].w + cb0[1].w;
  r4.w = 1 + v1.y;
  r5.w = dot(r4.xyz, -cb0[17].xyz);
  ...
  r0.y = cb0[18].w * r0.y;
  r0.y = r0.z ? 0 : r0.y;
  r1.xyz = t4.Sample(s4_s, w2.xy).xyz;
  r0.yzw = r0.yyy * r1.xyz + r3.xyz;
  r6.x = r5.w * 0.939999998 + 0.0500000007;
  r6.yw = float2(0.5,0.5);
  r1.xyz = t3.Sample(s3_s, r6.xy).xyz;
  r1.w = r1.w * 0.75 + 0.25;
  ...
  r6.z = r0.x * 0.939999998 + 0.0500000007;
  r1.xyz = t3.Sample(s3_s, r6.zw).xyz;
  r2.xyz = cb0[9].xyz * r2.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r1.xyz = max(float3(0,0,0), r1.xyz);
  r0.xyz = r1.xyz * r4.www + r0.yzw;
