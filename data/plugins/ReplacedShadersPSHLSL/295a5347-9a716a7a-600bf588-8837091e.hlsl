  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.w = sqrt(r4.w);
  r5.x = dot(r5.xyz, r0.xzw);
  r5.x = saturate(r5.x / r4.w);
  r4.w = 1 + -r4.w;
  r4.w = max(0, r4.w);
  r4.w = r5.x * r4.w;
  r5.xyz = cb0[34].xyz * r4.www;
  r5.xyz = cb0[32].xyz * r3.yyy + r5.xyz;
  r6.xyz = cb0[35].xyz + -v6.xyz;
  r6.xyz = cb0[35].www * r6.xyz;
  r3.y = dot(r6.xyz, r6.xyz);
  r3.y = sqrt(r3.y);
  r4.w = dot(r6.xyz, r0.xzw);
  r4.w = saturate(r4.w / r3.y);
  r5.w = 1 + -r3.y;
  r5.w = max(0, r5.w);
  r4.w = r5.w * r4.w;
  r5.w = dot(cb0[36].xyz, -r6.xyz);
  r3.y = r5.w / r3.y;
  r3.y = -cb0[37].w + r3.y;
  r3.y = saturate(cb0[36].w * r3.y);
  r6.xyz = cb0[37].xyz * r4.www;
  ...
  r3.y = r5.w / r3.y;
  r3.y = -cb0[40].w + r3.y;
  r3.y = saturate(cb0[39].w * r3.y);
  r6.xyz = cb0[40].xyz * r4.www;
  r5.xyz = r6.xyz * r3.yyy + r5.xyz;
