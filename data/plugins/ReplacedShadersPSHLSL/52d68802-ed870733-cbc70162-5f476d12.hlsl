  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  bitmask.z = ((~(-1 << 1)) << 1) & 0xffffffff;  r0.z = (((uint)v12.x << 1) & bitmask.z) | ((uint)0 & ~bitmask.z);
  r0.z = (int)r0.z + -1;
  r0.z = (int)r0.z;
  r2.xy = float2(0.699999988,0.699999988) * cb0[14].xy;
  r2.zw = v10.xy / v10.ww;
  r3.xy = r2.zw * float2(0.5,-0.5) + float2(0.5,0.5);
  r0.z = v11.y * r0.z + v10.z;
  r3.z = saturate(r0.z / v10.w);
  r0.z = -1 + cb0[15].x;
  r0.w = 360 / r0.z;
  r4.z = 0;
    r2.w = 0;
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r2.w : 0;
  r0.x = saturate(dot(-cb0[10].xyz, r0.xyw));
