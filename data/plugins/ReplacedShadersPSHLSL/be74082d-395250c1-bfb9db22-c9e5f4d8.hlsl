  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = cb0[5].www * r4.xyz + r1.xyz;
  r0.w = dot(r0.xyz, -cb0[19].xyz);
  r0.x = saturate(dot(-r0.xyz, r2.xyz));
  r0.y = saturate(r0.w * 5 + 1);
  r0.x = log2(r0.x);
  r0.x = cb0[4].w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r0.y;
  ...
  r3.z = r0.x * 0.939999998 + 0.0500000007;
  r0.xyz = t3.Sample(s3_s, r3.zw).xyz;
