  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = dot(r0.xzw, -cb0[18].xyz);
  r2.w = saturate(dot(-r0.xzw, r5.xyz));
  ...
  r1.xyz = cb0[5].www * r4.xyz + r1.xyz;
  r1.w = dot(r0.xzw, -cb0[19].xyz);
  r0.x = saturate(dot(-r0.xzw, r2.xyz));
  r0.z = saturate(r1.w * 5 + 1);
  r0.x = log2(r0.x);
  r0.x = cb0[4].w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x * r0.z;
