  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.y = max(0, r3.y);
  r3.x = r3.x * r3.y;
  r3.xyz = cb0[28].xyz * r3.xxx;
  r3.xyz = cb0[26].xyz * r2.www + r3.xyz;
  r4.xyz = cb0[29].xyz + -v6.xyz;
  r4.xyz = cb0[29].www * r4.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = sqrt(r2.w);
  r3.w = dot(r4.xyz, r1.yzw);
  r3.w = saturate(r3.w / r2.w);
  r4.w = 1 + -r2.w;
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.x = dot(cb0[30].xyz, -r4.xyz);
  r2.w = r4.x / r2.w;
  r2.w = -cb0[31].w + r2.w;
  r2.w = saturate(cb0[30].w * r2.w);
  r4.xyz = cb0[31].xyz * r3.www;
  ...
  r2.w = r4.x / r2.w;
  r2.w = -cb0[34].w + r2.w;
  r2.w = saturate(cb0[33].w * r2.w);
  r4.xyz = cb0[34].xyz * r3.www;
  r3.xyz = r4.xyz * r2.www + r3.xyz;
