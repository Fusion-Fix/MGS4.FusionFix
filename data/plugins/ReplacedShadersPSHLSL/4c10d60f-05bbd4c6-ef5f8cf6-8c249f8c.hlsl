  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = (int)r0.w + -1;
  r0.w = (int)r0.w;
  r1.w = dot(cb0[17].xyz, v5.xyz);
  r2.xy = float2(0.699999988,0.699999988) * cb0[24].xy;
  r2.zw = v7.xy / v7.ww;
  r3.xy = r2.zw * float2(0.5,-0.5) + float2(0.5,0.5);
  r0.w = v8.y * r0.w + v7.z;
  r3.z = saturate(r0.w / v7.w);
  r0.w = -1 + cb0[25].x;
  r2.z = 360 / r0.w;
  r4.z = 0;
    r3.w = 0;
  r4.w = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r5.y = r2.y * rotY + r3.y;
      r5.z = r3.z;
      r4.x = t2.SampleCmpLevelZero(s2_s, r5.xy, r5.z).x;
      r3.w = r4.x + r3.w;
    }
  }
  r0.w = 1 / cb0[25].x;
  ...
  r1.xyz = float3(0.00999999978,0.00999999978,0.00999999978) + r2.xyz;
