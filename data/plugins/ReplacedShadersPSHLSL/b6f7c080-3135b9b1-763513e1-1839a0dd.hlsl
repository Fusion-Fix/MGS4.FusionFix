  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r8.xyz = cb0[27].xyz + -v6.xyz;
  r8.xyz = cb0[27].www * r8.xyz;
  r2.w = dot(r8.xyz, r8.xyz);
  r2.w = sqrt(r2.w);
  r3.w = dot(r8.xyz, r4.xyz);
  r3.w = saturate(r3.w / r2.w);
  r2.w = 1 + -r2.w;
  r2.w = max(0, r2.w);
  r2.w = r3.w * r2.w;
  r8.xyz = cb0[29].xyz + -v6.xyz;
  r8.xyz = cb0[29].www * r8.xyz;
  ...
  r3.w = max(0, r3.w);
  r3.w = r4.w * r3.w;
  r8.xyz = cb0[30].xyz * r3.www;
  r8.xyz = cb0[28].xyz * r2.www + r8.xyz;
  r9.xyz = cb0[31].xyz + -v6.xyz;
  r9.xyz = cb0[31].www * r9.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.w = dot(cb0[32].xyz, -r9.xyz);
  r2.w = r4.w / r2.w;
  r2.w = -cb0[33].w + r2.w;
  r2.w = saturate(cb0[32].w * r2.w);
  r9.xyz = cb0[33].xyz * r3.www;
  r8.xyz = r9.xyz * r2.www + r8.xyz;
  r9.xyz = cb0[34].xyz + -v6.xyz;
  r9.xyz = cb0[34].www * r9.xyz;
  r2.w = dot(r9.xyz, r9.xyz);
  r2.w = sqrt(r2.w);
  r3.w = dot(r9.xyz, r4.xyz);
  r3.w = saturate(r3.w / r2.w);
  ...
  r0.w = exp2(r0.w);
  r0.w = r0.w * r1.x;
  r6.x = r2.w * 0.939999998 + 0.0500000007;
  r6.yw = float2(0.5,0.5);
  r1.xyz = t3.Sample(s3_s, r6.xy).xyz;
  r6.z = r0.w * 0.939999998 + 0.0500000007;
