  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = r4.xyz * r2.www + r2.xyz;
  r3.w = cb0[3].z * r3.y;
  r2.x = dot(r3.xzw, r3.xzw);
  r2.x = rsqrt(r2.x);
  r2.xz = r3.xz * r2.xx;
  r2.xz = saturate(r2.xz * float2(0.5,0.5) + float2(0.5,0.5));
  r2.xzw = t3.Sample(s3_s, r2.xz).xyz;
  r2.y = 1 + -abs(r2.y);
  r2.y = log2(r2.y);
  r2.y = cb0[3].x * r2.y;
  r2.y = exp2(r2.y);
  r2.y = saturate(cb0[3].y + r2.y);
  r1.w = r1.w * 0.5 + 0.5;
  r1.w = r2.y * r1.w;
  r2.xyz = r2.xzw * r1.www;
