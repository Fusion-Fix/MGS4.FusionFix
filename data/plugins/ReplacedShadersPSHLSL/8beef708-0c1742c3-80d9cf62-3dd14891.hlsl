  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.xyz = t4.Sample(s4_s, v3.xy).xyz;
  r4.xyz = r4.xyz + -r0.xyz;
  r0.xyz = r3.xxx * r4.xyz + r0.xyz;
  r3.xw = t5.Sample(s5_s, v3.xy).yw;
  ...
  r1.w = cb0[2].z + -cb0[1].w;
  r1.w = r3.z * r1.w + cb0[1].w;
  ...
  r4.w = dot(-r2.xyz, cb0[17].xyz);
  r5.w = dot(-r2.xyz, cb0[18].xyz);
  r6.x = saturate(dot(-r2.xyz, cb0[19].xyz));
  r6.yzw = r4.xyz * r3.www + cb0[17].xyz;
  r7.x = dot(r6.yzw, r6.yzw);
  r7.x = rsqrt(r7.x);
  r6.yzw = r7.xxx * r6.yzw;
  r6.y = saturate(dot(-r2.xyz, r6.yzw));
  r4.xyz = r4.xyz * r3.www + cb0[18].xyz;
  r3.w = dot(r4.xyz, r4.xyz);
  r3.w = rsqrt(r3.w);
  r4.xyz = r4.xyz * r3.www;
  r3.w = saturate(dot(-r2.xyz, r4.xyz));
  r4.x = saturate(r4.w * 5 + 1);
  r4.y = log2(r6.y);
  r4.y = r4.y * r1.w;
  r4.y = exp2(r4.y);
  r4.x = r4.y * r4.x;
  r4.y = saturate(r5.w * 5 + 1);
  r3.w = log2(r3.w);
  r1.w = r3.w * r1.w;
  r1.w = exp2(r1.w);
  r1.w = r1.w * r4.y;
  r6.yzw = cb0[8].xyz * r2.www;
  r4.w = saturate(r4.w);
  r5.w = saturate(r5.w);
  r7.xyz = cb0[9].xyz * r5.www;
  r4.yzw = r6.yzw * r4.www + r7.xyz;
  r4.yzw = cb0[10].xyz * r6.xxx + r4.yzw;
  r2.w = r2.w * 0.75 + 0.25;
  r6.xyz = cb0[8].xyz * r2.www;
  r7.xyz = cb0[9].xyz * r1.www;
  r6.xyz = r4.xxx * r6.xyz + r7.xyz;
  r7.xyz = cb0[26].xyz + -v7.xyz;
  r7.xyz = cb0[26].www * r7.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r7.xyz = cb0[28].xyz + -v7.xyz;
  r7.xyz = cb0[28].www * r7.xyz;
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.w * r2.w;
  r7.xyz = cb0[29].xyz * r2.www;
  r7.xyz = cb0[27].xyz * r1.www + r7.xyz;
  r8.xyz = cb0[30].xyz + -v7.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[31].xyz, -r8.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[32].w + r1.w;
  r1.w = saturate(cb0[31].w * r1.w);
  r8.xyz = cb0[32].xyz * r2.www;
  r7.xyz = r8.xyz * r1.www + r7.xyz;
  r8.xyz = cb0[33].xyz + -v7.xyz;
  r8.xyz = cb0[33].www * r8.xyz;
  r1.w = dot(r8.xyz, r8.xyz);
  r1.w = sqrt(r1.w);
  r2.w = dot(r8.xyz, r2.xyz);
  r2.w = saturate(r2.w / r1.w);
  ...
  r1.w = r3.w / r1.w;
  r1.w = -cb0[35].w + r1.w;
  r1.w = saturate(cb0[34].w * r1.w);
  r8.xyz = cb0[35].xyz * r2.www;
  r7.xyz = r8.xyz * r1.www + r7.xyz;
  r4.xyz = r7.xyz + r4.yzw;
  r1.w = dot(-r2.xyz, cb0[16].xyz);
  r7.xyz = cb0[11].xyz * r1.www + cb0[12].xyz;
  r7.xyz = cb0[1].xyz * r7.xyz;
  r4.xyz = r4.xyz * cb0[0].xyz + r7.xyz;
  r7.xyz = t3.Sample(s3_s, w2.xy).xyz;
  r8.xyz = t6.Sample(s6_s, w2.xy).xyz;
  r8.xyz = r8.xyz + -r7.xyz;
  r7.xyz = r3.zzz * r8.xyz + r7.xyz;
