  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r7.x = abs(r0.w) * 0.939999998 + 0.0500000007;
  r7.yw = float2(0.5,0.5);
  r8.xyz = t5.Sample(s5_s, r7.xy).xyz;
  r4.xyz = r8.xyz * r4.xyz;
  r4.xyz = r4.xyz + r4.xyz;
  r2.w = dot(-r2.xyz, cb0[17].xyz);
  r8.xyz = cb0[12].xyz * r2.www + cb0[13].xyz;
  ...
  r2.w = 1 + v1.y;
  r3.xzw = cb0[4].xyz * r2.www;
  r2.w = dot(r2.xyz, -cb0[18].xyz);
  r2.w = saturate(r2.w * 5 + 1);
  r3.y = r0.w * r3.y;
  r3.y = exp2(r3.y);
  r2.w = r3.y * r2.w;
  r7.z = r2.w * 0.939999998 + 0.0500000007;
  ...
  r0.w = exp2(r0.w);
  r0.w = r0.w * r2.x;
  r2.x = r0.w * 0.939999998 + 0.0500000007;
  r2.y = 0.5;
