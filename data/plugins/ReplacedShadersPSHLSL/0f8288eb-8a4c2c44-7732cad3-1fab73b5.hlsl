  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.w = max(0, r3.w);
  r3.w = r4.w * r3.w;
  r6.xyz = cb0[30].xyz * r3.www;
  r6.xyz = cb0[28].xyz * r2.www + r6.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.w = dot(cb0[32].xyz, -r7.xyz);
  r2.w = r4.w / r2.w;
  r2.w = -cb0[33].w + r2.w;
  r2.w = saturate(cb0[32].w * r2.w);
  r7.xyz = cb0[33].xyz * r3.www;
