  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.w = saturate(dot(-r3.xyz, cb0[19].xyz));
  r4.x = saturate(dot(-r3.xyz, cb0[20].xyz));
  r4.yzw = cb0[9].xyz * r1.www;
  r5.xyz = cb0[10].xyz * r3.www;
  r4.yzw = r4.yzw * r2.www + r5.xyz;
  r4.xyz = cb0[11].xyz * r4.xxx + r4.yzw;
  r2.w = dot(-r3.xyz, cb0[17].xyz);
  ...
  r3.w = max(0, r3.w);
  r3.w = r4.w * r3.w;
  r6.xyz = cb0[34].xyz * r3.www;
  r6.xyz = cb0[32].xyz * r2.www + r6.xyz;
  r7.xyz = cb0[35].xyz + -v6.xyz;
  ...
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.w = dot(cb0[36].xyz, -r7.xyz);
  r2.w = r4.w / r2.w;
  r2.w = -cb0[37].w + r2.w;
  r2.w = saturate(cb0[36].w * r2.w);
  r7.xyz = cb0[37].xyz * r3.www;
  r6.xyz = r7.xyz * r2.www + r6.xyz;
  r7.xyz = cb0[38].xyz + -v6.xyz;
  ...
  r7.xyz = cb0[40].xyz * r3.www;
  r6.xyz = r7.xyz * r2.www + r6.xyz;
  r4.xyz = r6.xyz + r4.xyz;
  r4.xyz = r4.xyz + r5.xyz;
  r2.w = dot(r3.xyz, -cb0[18].xyz);
  r5.xyz = r1.xyz * r0.www + cb0[18].xyz;
  ...
  r0.w = exp2(r0.w);
  r0.w = r0.w * r1.x;
  r3.x = r2.w * 0.939999998 + 0.0500000007;
  r3.yw = float2(0.5,0.5);
  r1.xyz = t3.Sample(s3_s, r3.xy).xyz;
