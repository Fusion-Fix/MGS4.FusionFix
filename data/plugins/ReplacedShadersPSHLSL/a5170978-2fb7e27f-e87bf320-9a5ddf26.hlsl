  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.xy = float2(0.699999988,0.699999988) * cb0[14].xy;
  r4.zw = v8.xy / v8.ww;
  ...
  r5.w = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r6.y = r4.y * rotY + r5.y;
      r6.w = r5.z;
      r6.x = t8.SampleCmpLevelZero(s8_s, r6.xy, r6.w).x;
      r4.w = r6.x + r4.w;
    }
  }
  r1.w = 1 / cb0[15].x;
  ...
  r1.y = t1.Sample(s1_s, v4.xy).x;
  r1.w = t1.Sample(s1_s, v4.zw).y;
  r2.x = t1.Sample(s1_s, v5.xy).z;
  r7.xyzw = t2.Sample(s2_s, r2.zw).xyzw;
  r2.yzw = r7.xyz * r6.xyz;
  r1.y = r1.y * r1.w + r2.x;
  r1.y = saturate(r7.w * r1.y);
  r6.xyz = w2.xyz * r0.xxx + -cb0[9].xyz;
  r0.x = dot(r6.xyz, r6.xyz);
  r0.x = rsqrt(r0.x);
  r6.xyz = r6.xyz * r0.xxx;
  r0.x = dot(-cb0[9].xyz, r6.xyz);
  r0.x = 1 + -r0.x;
  r1.w = r0.x * r0.x;
  r1.w = r1.w * r1.w;
  r0.x = r1.w * r0.x;
  ...
  r0.x = 1 + r0.x;
  r6.xy = v0.xy / cb0[13].xy;
  r1.w = t9.Sample(s9_s, r6.xy).x;
  r2.x = v1.w * r3.w;
  r1.w = -v7.w + r1.w;
  r1.w = max(0, r1.w);
  r1.w = saturate(v7.z * r1.w);
  r1.w = r2.x * r1.w;
  r1.xz = cb0[1].ww * r1.xz;
  r1.xz = r1.xz * r1.ww;
  r1.xz = float2(0.100000001,0.100000001) * r1.xz;
  r6.xy = r1.xz * cb0[13].xy + v0.xy;
  r6.xy = r6.xy / cb0[13].xy;
  r2.x = t9.Sample(s9_s, r6.xy).x;
  r2.x = cmp(r2.x >= v7.w);
  r2.x = r2.x ? 1.000000 : 0;
  r1.xz = r2.xx * r1.xz;
  r1.xz = v0.xy * cb0[12].xy + r1.xz;
  r6.xyzw = t7.Sample(s7_s, r1.xz).xyzw;
