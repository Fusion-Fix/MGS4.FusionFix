  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.yzw = r5.yzw * r3.www + r6.xyz;
  r3.yzw = cb0[11].xyz * r5.xxx + r3.yzw;
  r1.w = r1.w * 0.75 + 0.25;
  ...
  r6.x = abs(r1.w) * 0.939999998 + 0.0500000007;
  r6.y = 0.5;
  r6.xyz = t5.Sample(s5_s, r6.xy).xyz;
  r4.xyz = r6.xyz * r4.xyz;
  r4.xyz = r4.xyz + r4.xyz;
  r2.x = dot(-r2.xyz, cb0[17].xyz);
  r2.xyz = cb0[12].xyz * r2.xxx + cb0[13].xyz;
  ...
  r1.w = cb0[19].w * r1.w;
  r1.w = r2.w ? 0 : r1.w;
  r3.xyz = t3.Sample(s3_s, w2.xy).xyz;
