  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xyz = t3.Sample(s3_s, w2.xy).xyz;
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r2.w : 0;
  r4.xyz = -cb0[23].xyz + v9.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = rsqrt(r2.w);
  r3.w = dot(-r3.xyz, cb0[18].xyz);
  r4.w = dot(-r3.xyz, cb0[19].xyz);
  r5.x = saturate(dot(-r3.xyz, cb0[20].xyz));
  r5.yzw = r4.xyz * r2.www + cb0[18].xyz;
  ...
  r2.w = exp2(r2.w);
  r2.w = r2.w * r4.y;
  r5.yzw = cb0[9].xyz * r1.www;
  r3.w = saturate(r3.w);
  r4.w = saturate(r4.w);
  r4.yzw = cb0[10].xyz * r4.www;
  r4.yzw = r5.yzw * r3.www + r4.yzw;
  r4.yzw = cb0[11].xyz * r5.xxx + r4.yzw;
  r1.w = r1.w * 0.75 + 0.25;
  r5.xyz = cb0[9].xyz * r1.www;
  r6.xyz = cb0[10].xyz * r2.www;
  r5.xyz = r4.xxx * r5.xyz + r6.xyz;
  r6.xyz = cb0[31].xyz + -v9.xyz;
  r6.xyz = cb0[31].www * r6.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r6.xyz = cb0[33].xyz + -v9.xyz;
  r6.xyz = cb0[33].www * r6.xyz;
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.w * r2.w;
  r6.xyz = cb0[34].xyz * r2.www;
  r6.xyz = cb0[32].xyz * r1.www + r6.xyz;
  r7.xyz = cb0[35].xyz + -v9.xyz;
  r7.xyz = cb0[35].www * r7.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[36].xyz, -r7.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[37].w + r1.w;
  r1.w = saturate(cb0[36].w * r1.w);
  r7.xyz = cb0[37].xyz * r2.www;
  r6.xyz = r7.xyz * r1.www + r6.xyz;
  r7.xyz = cb0[38].xyz + -v9.xyz;
  ...
  r7.xyz = cb0[40].xyz * r2.www;
  r6.xyz = r7.xyz * r1.www + r6.xyz;
  r4.xyz = r6.xyz + r4.yzw;
  r1.w = dot(-r3.xyz, cb0[17].xyz);
  r6.xyz = cb0[12].xyz * r1.www + cb0[13].xyz;
  r6.xyz = cb0[2].xyz * r6.xyz;
  r4.xyz = r4.xyz * cb0[1].xyz + r6.xyz;
  r6.xyz = v4.xyz * r3.yyy;
  r3.xyw = v3.xyz * r3.xxx + r6.xyz;
  r3.xyz = v5.xyz * r3.zzz + r3.xyw;
  r1.w = dot(r3.xyz, r3.xyz);
  r1.w = rsqrt(r1.w);
  r3.xy = r3.xy * r1.ww;
