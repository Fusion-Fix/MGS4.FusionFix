  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.x * r2.w;
  r5.xyz = cb0[34].xyz * r2.www;
  r5.xyz = cb0[32].xyz * r1.www + r5.xyz;
  r6.xyz = cb0[35].xyz + -v7.xyz;
  ...
  r3.x = max(0, r3.x);
  r2.w = r3.x * r2.w;
  r3.x = dot(cb0[36].xyz, -r6.xyz);
  r1.w = r3.x / r1.w;
  r1.w = -cb0[37].w + r1.w;
  r1.w = saturate(cb0[36].w * r1.w);
  r6.xyz = cb0[37].xyz * r2.www;
  r5.xyz = r6.xyz * r1.www + r5.xyz;
  r6.xyz = cb0[38].xyz + -v7.xyz;
