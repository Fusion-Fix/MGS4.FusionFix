  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.xy = cb0[3].zz * r2.xy;
  r1.xy = r2.xy * float2(2,2) + r1.xy;
  r2.xyz = v5.xyz * r1.yyy;
  r1.xyw = v4.xyz * r1.xxx + r2.xyz;
  r1.xyz = v6.xyz * r1.zzz + r1.xyw;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  r1.w = dot(cb0[18].xyz, r1.xyz);
  r2.x = 1 / cb0[26].x;
  r2.y = r3.w * r2.x;
  r2.x = -r3.w * r2.x + 1;
  r2.z = saturate(v9.x);
  ...
  r1.w = cmp(r1.w < 0);
  r1.w = r1.w ? r2.x : 0;
  r2.xyz = -cb0[23].xyz + v7.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r2.xyz = r2.xyz * r2.www;
  r2.w = saturate(dot(-r1.xyz, cb0[18].xyz));
  r3.x = saturate(dot(-r1.xyz, cb0[19].xyz));
  r3.y = saturate(dot(-r1.xyz, cb0[20].xyz));
  r4.xyz = cb0[9].xyz * r1.www;
  r3.xzw = cb0[10].xyz * r3.xxx;
  r3.xzw = r4.xyz * r2.www + r3.xzw;
  r3.xyz = cb0[11].xyz * r3.yyy + r3.xzw;
  r4.xyz = cb0[27].xyz + -v7.xyz;
  r4.xyz = cb0[27].www * r4.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r4.xyz = cb0[29].xyz + -v7.xyz;
  r4.xyz = cb0[29].www * r4.xyz;
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.w * r2.w;
  r4.xyz = cb0[30].xyz * r2.www;
  r4.xyz = cb0[28].xyz * r1.www + r4.xyz;
  r5.xyz = cb0[31].xyz + -v7.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[32].xyz, -r5.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[33].w + r1.w;
  r1.w = saturate(cb0[32].w * r1.w);
  r5.xyz = cb0[33].xyz * r2.www;
  r4.xyz = r5.xyz * r1.www + r4.xyz;
  r5.xyz = cb0[34].xyz + -v7.xyz;
  r5.xyz = cb0[34].www * r5.xyz;
  r1.w = dot(r5.xyz, r5.xyz);
  r1.w = sqrt(r1.w);
  r2.w = dot(r5.xyz, r1.xyz);
  r2.w = saturate(r2.w / r1.w);
  ...
  r5.xyz = cb0[36].xyz * r2.www;
  r4.xyz = r5.xyz * r1.www + r4.xyz;
  r3.xyz = r4.xyz + r3.xyz;
  r1.w = dot(-r1.xyz, cb0[17].xyz);
  r4.xyz = cb0[12].xyz * r1.www + cb0[13].xyz;
  r4.xyz = cb0[2].xyz * r4.xyz;
  r3.xyz = r3.xyz * cb0[1].xyz + r4.xyz;
  r4.xyz = t3.Sample(s3_s, w2.xy).xyz;
  ...
  r1.w = max(cb0[21].z, v2.x);
  r1.w = min(cb0[21].w, r1.w);
  r1.w = cb0[22].w * r1.w;
  r0.xyz = -r0.xyz * r3.xyz + cb0[22].xyz;
