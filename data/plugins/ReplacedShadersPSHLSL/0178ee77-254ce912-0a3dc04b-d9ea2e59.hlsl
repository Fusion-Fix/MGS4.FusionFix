  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r6.xyz = cb0[26].xyz + -v9.xyz;
  r6.xyz = cb0[26].www * r6.xyz;
  r1.w = dot(r6.xyz, r6.xyz);
  r1.w = sqrt(r1.w);
  r4.x = dot(r6.xyz, r4.yzw);
  r4.x = saturate(r4.x / r1.w);
  r1.w = 1 + -r1.w;
  r1.w = max(0, r1.w);
  r1.w = r4.x * r1.w;
  r6.xyz = cb0[28].xyz + -v9.xyz;
  r6.xyz = cb0[28].www * r6.xyz;
  r4.x = dot(r6.xyz, r6.xyz);
  r4.x = sqrt(r4.x);
  r5.w = dot(r6.xyz, r4.yzw);
  r5.w = saturate(r5.w / r4.x);
  r4.x = 1 + -r4.x;
  r4.x = max(0, r4.x);
  r4.x = r5.w * r4.x;
  r6.xyz = cb0[29].xyz * r4.xxx;
  r6.xyz = cb0[27].xyz * r1.www + r6.xyz;
  r7.xyz = cb0[30].xyz + -v9.xyz;
  ...
  r7.xyz = cb0[32].xyz * r4.xxx;
  r6.xyz = r7.xyz * r1.www + r6.xyz;
  r7.xyz = cb0[33].xyz + -v9.xyz;
