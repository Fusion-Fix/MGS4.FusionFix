  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r3.z = r0.z * rotY + r1.y;
      r3.w = r1.z;
      r2.x = t2.SampleCmpLevelZero(s2_s, r3.yz, r3.w).x;
      r2.w = r2.x + r2.w;
    }
  }
  r0.x = cmp(0 < cb0[23].x);
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r1.w : 0;
  r1.w = saturate(dot(-v5.xyz, cb0[17].xyz));
  r2.x = saturate(dot(-v5.xyz, cb0[18].xyz));
  r2.y = saturate(dot(-v5.xyz, cb0[19].xyz));
  r3.xyz = cb0[8].xyz * r0.www;
  r2.xzw = cb0[9].xyz * r2.xxx;
  r2.xzw = r3.xyz * r1.www + r2.xzw;
  r2.xyz = cb0[10].xyz * r2.yyy + r2.xzw;
  r0.w = dot(-v5.xyz, cb0[16].xyz);
  r3.xyz = cb0[11].xyz * r0.www + cb0[12].xyz;
  r3.xyz = cb0[1].xyz * r3.xyz;
  r2.xyz = r2.xyz * cb0[0].xyz + r3.xyz;
  r3.xyz = cb0[26].xyz + -v6.xyz;
  r3.xyz = cb0[26].www * r3.xyz;
  ...
  r1.w = max(0, r1.w);
  r1.w = r2.w * r1.w;
  r3.xyz = cb0[29].xyz * r1.www;
  r3.xyz = cb0[27].xyz * r0.www + r3.xyz;
  r4.xyz = cb0[30].xyz + -v6.xyz;
  r4.xyz = cb0[30].www * r4.xyz;
  r0.w = dot(r4.xyz, r4.xyz);
  r0.w = sqrt(r0.w);
  r1.w = dot(r4.xyz, v5.xyz);
  r1.w = saturate(r1.w / r0.w);
  r2.w = 1 + -r0.w;
  r2.w = max(0, r2.w);
  r1.w = r2.w * r1.w;
  r2.w = dot(cb0[31].xyz, -r4.xyz);
  r0.w = r2.w / r0.w;
  r0.w = -cb0[32].w + r0.w;
  r0.w = saturate(cb0[31].w * r0.w);
  r4.xyz = cb0[32].xyz * r1.www;
  r3.xyz = r4.xyz * r0.www + r3.xyz;
  r4.xyz = cb0[33].xyz + -v6.xyz;
  ...
  r3.xyz = cb0[3].xyz * r0.xyz;
  r4.xyz = float3(0.00999999978,0.00999999978,0.00999999978) + r2.xyz;
  r0.w = dot(r4.xyz, r4.xyz);
  r0.w = rsqrt(r0.w);
  r4.xyz = saturate(r4.xyz * r0.www);
  r3.xyz = r4.xyz * r3.xyz;
  r4.xyz = float3(1.73204994,1.73204994,1.73204994) * r3.xyz;
  ...
  r0.x = min(1, r0.x);
  r0.yzw = cb0[2].xyz * r2.xyz;
  r1.xyz = r3.xyz * float3(1.73204994,1.73204994,1.73204994) + -r0.yzw;
  r0.yzw = r0.xxx * r1.xyz + r0.yzw;
  r0.yzw = -r3.xyz * float3(1.73204994,1.73204994,1.73204994) + r0.yzw;
