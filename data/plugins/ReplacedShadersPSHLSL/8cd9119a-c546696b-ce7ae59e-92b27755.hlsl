  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r7.x = abs(r1.w) * 0.939999998 + 0.0500000007;
  r7.yw = float2(0.5,0.5);
  r8.xyz = t5.Sample(s5_s, r7.xy).xyz;
  r4.xyz = r8.xyz * r4.xyz;
  r4.xyz = r4.xyz + r4.xyz;
  r4.w = dot(-r2.xyz, cb0[17].xyz);
  r8.xyz = cb0[12].xyz * r4.www + cb0[13].xyz;
  r8.xyz = cb0[2].xyz * r8.xyz;
  r4.xyz = r8.xyz * r4.xyz;
  r4.xyz = r5.xyz * cb0[1].xyz + r4.xyz;
  r1.w = 1 + -abs(r1.w);
  r4.w = cmp(r1.w < 0.00999999978);
  r1.w = log2(r1.w);
  r1.w = cb0[3].x * r1.w;
  r1.w = exp2(r1.w);
  r1.w = cb0[3].y * r1.w;
  r1.w = cb0[19].w * r1.w;
  r1.w = r4.w ? 0 : r1.w;
  r5.xyz = t3.Sample(s3_s, w2.xy).xyz;
  r0.xyz = r1.www * r5.xyz + r0.xyz;
  r3.xzw = r3.xzw * r1.xyz;
  r3.xzw = cb0[5].www * -r3.xzw + r3.xzw;
  r0.xyz = r0.xyz * r4.xyz + r3.xzw;
  r1.w = v1.y * -cb0[4].w + cb0[4].w;
  r3.x = 1 + v1.y;
  r3.xzw = cb0[4].xyz * r3.xxx;
  r4.x = dot(r2.xyz, -cb0[18].xyz);
  r4.x = saturate(r4.x * 5 + 1);
  r3.y = r1.w * r3.y;
  r3.y = exp2(r3.y);
  r3.y = r3.y * r4.x;
  r7.z = r3.y * 0.939999998 + 0.0500000007;
  r4.xyz = t7.Sample(s7_s, r7.zw).xyz;
  r5.xyz = r6.xyz * r1.xyz;
  r4.xyz = r5.xyz * r4.xyz;
  r4.xyz = max(float3(0,0,0), r4.xyz);
  r4.xyz = r4.xyz * r3.xzw;
  r0.xyz = cb0[5].www * r4.xyz + r0.xyz;
  r2.x = dot(r2.xyz, -cb0[19].xyz);
  r2.x = saturate(r2.x * 5 + 1);
  r1.w = r1.w * r2.w;
  r1.w = exp2(r1.w);
  r1.w = r1.w * r2.x;
  r2.x = r1.w * 0.939999998 + 0.0500000007;
  r2.y = 0.5;
  r2.xyz = t7.Sample(s7_s, r2.xy).xyz;
