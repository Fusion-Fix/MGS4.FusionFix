  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = (int)r0.w + -1;
  r0.w = (int)r0.w;
  r1.w = dot(cb0[17].xyz, r2.xyz);
  r3.xy = float2(0.699999988,0.699999988) * cb0[24].xy;
  r3.zw = v9.xy / v9.ww;
  r4.xy = r3.zw * float2(0.5,-0.5) + float2(0.5,0.5);
  r0.w = v10.y * r0.w + v9.z;
  r4.z = saturate(r0.w / v9.w);
  r0.w = -1 + cb0[25].x;
  r2.w = 360 / r0.w;
  r5.z = 0;
    r3.w = 0;
  r4.w = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r5.y = r3.y * rotY + r4.y;
      r5.w = r4.z;
      r5.x = t4.SampleCmpLevelZero(s4_s, r5.xy, r5.w).x;
      r3.w = r5.x + r3.w;
    }
  }
  r0.w = 1 / cb0[25].x;
  ...
  r0.xyz = cb0[2].www * r0.xyz + r1.xyz;
