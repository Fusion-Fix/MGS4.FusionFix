  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.w = max(0, r4.w);
  r4.w = r5.x * r4.w;
  r5.xyz = cb0[30].xyz * r4.www;
  r5.xyz = cb0[28].xyz * r3.yyy + r5.xyz;
  ...
  r5.w = max(0, r5.w);
  r4.w = r5.w * r4.w;
  r5.w = dot(cb0[32].xyz, -r6.xyz);
  r3.y = r5.w / r3.y;
  r3.y = -cb0[33].w + r3.y;
  r3.y = saturate(cb0[32].w * r3.y);
  ...
  r3.y = r5.w / r3.y;
  r3.y = -cb0[36].w + r3.y;
  r3.y = saturate(cb0[35].w * r3.y);
  r6.xyz = cb0[36].xyz * r4.www;
  r5.xyz = r6.xyz * r3.yyy + r5.xyz;
