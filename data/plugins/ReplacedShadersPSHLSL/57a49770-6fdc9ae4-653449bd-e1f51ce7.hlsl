  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.x = 0;
  {
    ...
    for (int j = 0; j < 8; j++) {
      ...
      r4.z = r1.z * rotY + r2.y;
      r4.w = r2.z;
      r3.x = t6.SampleCmpLevelZero(s6_s, r4.yz, r4.w).x;
      r3.w = r3.x + r3.w;
    }
  }
  r0.w = v1.w * r0.w;
  ...
  r4.w = dot(-r2.xyw, cb0[18].xyz);
  r5.x = dot(-r2.xyw, cb0[19].xyz);
  r5.y = saturate(dot(-r2.xyw, cb0[20].xyz));
  r6.xyz = r3.xyz * r3.www + cb0[18].xyz;
  r5.z = dot(r6.xyz, r6.xyz);
  r5.z = rsqrt(r5.z);
  r6.xyz = r6.xyz * r5.zzz;
  r5.z = saturate(dot(-r2.xyw, r6.xyz));
  r3.xyz = r3.xyz * r3.www + cb0[19].xyz;
  r3.w = dot(r3.xyz, r3.xyz);
  r3.w = rsqrt(r3.w);
  r3.xyz = r3.xyz * r3.www;
  r3.x = saturate(dot(-r2.xyw, r3.xyz));
  r3.y = saturate(r4.w * 5 + 1);
  r3.z = log2(r5.z);
  r3.w = cb0[2].w * r3.z;
  r3.w = exp2(r3.w);
  r3.y = r3.w * r3.y;
  r3.w = saturate(r5.x * 5 + 1);
  r3.x = log2(r3.x);
  r5.z = cb0[2].w * r3.x;
  r5.z = exp2(r5.z);
  r3.w = r5.z * r3.w;
  r6.xyz = cb0[9].xyz * r1.www;
  r4.w = saturate(r4.w);
  r5.x = saturate(r5.x);
  r5.xzw = cb0[10].xyz * r5.xxx;
  r5.xzw = r6.xyz * r4.www + r5.xzw;
  r5.xyz = cb0[11].xyz * r5.yyy + r5.xzw;
  r1.w = r1.w * 0.75 + 0.25;
  r6.xyz = cb0[9].xyz * r1.www;
  r7.xyz = cb0[10].xyz * r3.www;
  r7.xyz = r3.yyy * r6.xyz + r7.xyz;
  r1.w = dot(-r2.xyw, cb0[17].xyz);
  r8.xyz = cb0[12].xyz * r1.www + cb0[13].xyz;
  r8.xyz = cb0[2].xyz * r8.xyz;
  r5.xyz = r5.xyz * cb0[1].xyz + r8.xyz;
  r8.xyz = t3.Sample(s3_s, w2.xy).xyz;
  r1.w = dot(r2.xyw, r4.xyz);
  r1.w = 1 + -abs(r1.w);
  r3.y = cmp(r1.w < 0.00999999978);
  r1.w = log2(r1.w);
  r1.w = cb0[3].z * r1.w;
  r1.w = exp2(r1.w);
  r1.w = cb0[3].w * r1.w;
  ...
  r1.w = v1.y * -cb0[4].w + cb0[4].w;
  r3.y = 1 + v1.y;
  r4.xyz = cb0[4].xyz * r3.yyy;
  r3.y = dot(r2.xyw, -cb0[18].xyz);
  r3.y = saturate(r3.y * 5 + 1);
  r3.z = r1.w * r3.z;
  r3.z = exp2(r3.z);
  r3.y = r3.z * r3.y;
  r5.x = r3.y * 0.939999998 + 0.0500000007;
  r5.yw = float2(0.5,0.5);
  r3.yzw = t4.Sample(s4_s, r5.xy).xyz;
  r6.xyz = r6.xyz * r1.xyz;
  r3.yzw = r6.xyz * r3.yzw;
  r3.yzw = max(float3(0,0,0), r3.yzw);
  r3.yzw = r3.yzw * r4.xyz;
  r0.xyz = r2.zzz * r3.yzw + r0.xyz;
  r2.x = dot(r2.xyw, -cb0[19].xyz);
  r2.x = saturate(r2.x * 5 + 1);
  r1.w = r1.w * r3.x;
  r1.w = exp2(r1.w);
  r1.w = r1.w * r2.x;
  r5.z = r1.w * 0.939999998 + 0.0500000007;
  r2.xyw = t4.Sample(s4_s, r5.zw).xyz;
