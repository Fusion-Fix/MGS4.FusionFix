  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r1.w : 0;
  r1.w = saturate(dot(-cb0[10].xyz, r4.xyz));
  ...
  r2.w = max(0, r2.w);
  r2.w = r3.x * r2.w;
  r3.xyz = cb0[20].xyz * r2.www;
  r3.xyz = cb0[18].xyz * r1.www + r3.xyz;
  ...
  r3.w = max(0, r3.w);
  r2.w = r3.w * r2.w;
  r3.w = dot(cb0[22].xyz, -r5.xyz);
  r1.w = r3.w / r1.w;
  r1.w = -cb0[23].w + r1.w;
  r1.w = saturate(cb0[22].w * r1.w);
  r5.xyz = cb0[23].xyz * r2.www;
  ...
  r0.xyw = v1.www * r0.xyw;
  r0.xyw = r0.xyw + r0.xyw;
  r0.xyw = r1.xyz * r2.xyz + r0.xyw;
  r1.x = max(cb0[11].z, w2.x);
  r1.x = min(cb0[11].w, r1.x);
  r1.x = cb0[12].w * r1.x;
  r1.yzw = cb0[12].xyz + -r0.xyw;
  o0.xyz = r1.xxx * r1.yzw + r0.xyw;
  r0.x = cmp(0 < cb0[14].x);
  if (r0.x != 0) {
    r0.yw = floor(v0.xy);
    r0.yw = (uint2)r0.yw;
