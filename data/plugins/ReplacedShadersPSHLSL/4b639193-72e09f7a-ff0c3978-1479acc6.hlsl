  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = (int)r0.x + -1;
  r0.x = (int)r0.x;
  r0.yz = float2(0.699999988,0.699999988) * cb0[14].xy;
  r1.xy = v11.xy / v11.ww;
  ...
  r0.w = cmp(r0.w < 0);
  r0.w = r0.w ? r2.x : 0;
  r2.x = saturate(dot(-cb0[9].xyz, r3.xyz));
  r2.yzw = cb0[8].xyz * r0.www;
  r1.xyz = r2.yzw * r2.xxx + r1.xyz;
  r2.xyz = cb0[16].xyz + -v10.xyz;
  ...
  r2.y = max(0, r2.y);
  r2.x = r2.x * r2.y;
  r2.yzw = cb0[18].xyz + -v10.xyz;
  r2.yzw = cb0[18].www * r2.yzw;
  ...
  r2.z = max(0, r2.z);
  r2.y = r2.y * r2.z;
  r2.yzw = cb0[19].xyz * r2.yyy;
  r2.xyz = cb0[17].xyz * r2.xxx + r2.yzw;
  ...
  r4.w = max(0, r4.w);
  r3.w = r4.w * r3.w;
  r4.x = dot(cb0[21].xyz, -r4.xyz);
  r2.w = r4.x / r2.w;
  r2.w = -cb0[22].w + r2.w;
  r2.w = saturate(cb0[21].w * r2.w);
  ...
  r2.w = r4.x / r2.w;
  r2.w = -cb0[25].w + r2.w;
  r2.w = saturate(cb0[24].w * r2.w);
  r4.xyz = cb0[25].xyz * r3.www;
  r2.xyz = r4.xyz * r2.www + r2.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r2.xyz = -cb0[12].xyz + v10.xyz;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
